function getRangeIntersection(range1, range2) {
  if (range1.getSheet().getSheetId() == range2.getSheet().getSheetId()) {
    ...
    var numColumns1 = Math.max(0, lastColumn1 - firstColumn1 + 1)
    ...
    var numColumn2 = Math.max(0, lastColumn2 - firstColumn2 + 1)
