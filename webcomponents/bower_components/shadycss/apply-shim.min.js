...
*/
    ...
    a.parent &&
      ...
      a.atRule
        ? 0 === b.indexOf('@media')
          ? (a.type = u)
          : b.match(ea) &&
            ((a.type = v), (a.keyframesName = a.selector.split(t).pop()))
        : (a.type = 0 === b.indexOf('--') ? w : y))
    if ((b = a.rules))
      for (var d = 0, e = b.length, f; d < e && (f = b[d]); d++) r(f, c)
    return a
  }
  function da(a) {
  ...
  function z(a, c, b) {
    ...
    if (a.cssText || a.rules) {
      ...
      if (f) {
        f = 0
        for (var h = e.length, g; f < h && (g = e[f]); f++) d = z(g, c, d)
      } else
        c
          ? (c = a.cssText)
          : ((c = a.cssText),
            (c = c.replace(fa, '').replace(ha, '')),
            (c = c.replace(ia, '').replace(ja, ''))),
          (d = c.trim()) && (d = '  ' + d + '\n')
    }
    d &&
  ...
  var B = !(window.ShadyDOM && window.ShadyDOM.inUse),
    C
  function D(a) {
    C =
  ...
  window.ShadyCSS && void 0 !== window.ShadyCSS.nativeCss
    ? (C = window.ShadyCSS.nativeCss)
    : window.ShadyCSS
      ? (D(window.ShadyCSS), (window.ShadyCSS = void 0))
      : D(window.WebComponents && window.WebComponents.flags)
  var E = C
  ...
  function L(a, c, b, d) {
    if (a) {
      var e = !1,
        f = a.type
      if (d && f === u) {
        var h = a.selector.match(na)
        h && (window.matchMedia(h[1]).matches || (e = !0))
      }
      f === y ? c(a) : b && f === v ? b(a) : f === w && (e = !0)
      if ((a = a.rules) && !e) {
        e = 0
        f = a.length
        for (var g; e < f && (g = a[e]); e++) L(g, c, b, d)
      }
    }
  }
  function M(a, c) {
      ...
      for (
        ...
        if (f.hasAttribute('shady-unscoped')) {
          if (!B) {
            var h = f.textContent
            I.has(h) ||
              (I.add(h), (h = f.cloneNode(!0)), document.head.appendChild(h))
  ...
  Q.prototype.g = function(a) {
    a.cssText = qa(this, a.parsedCssText)
    ':root' === a.selector && (a.selector = ':host > *')
  }
  function qa(a, c) {
    c = c.replace(G, function(b, c, e, f) {
      return ra(a, b, c, e, f)
    })
    return R(a, c)
  }
  function R(a, c) {
    for (var b; (b = H.exec(c)); ) {
      var d = b[0],
        e = b[1]
      b = b.index
      ...
      if (l) {
        ...
        for (d in q)
          (g = h && h[d]),
            (l = [d, ': var(', e, '_-_', d]),
            g && l.push(',', g.replace(N, '')),
            l.push(')'),
            N.test(q[d]) && l.push(' !important'),
            m.push(l.join(''))
      }
      d = m.join('; ')
      c = '' + f + d + c
      H.lastIndex = b + d.length
    }
    return c
  }
  function S(a, c) {
  ...
  function sa(a, c) {
    if (P) for (var b in c.i) b !== a.c && P(b)
  }
  ...
  Q.prototype.detectMixin = Q.prototype.o
  Q.prototype.transformStyle = Q.prototype.j
  Q.prototype.transformCustomStyle = Q.prototype.f
  Q.prototype.transformRules = Q.prototype.l
  Q.prototype.transformRule = Q.prototype.g
  Q.prototype.transformTemplate = Q.prototype.m
  Q.prototype._separator = '_-_'
  Object.defineProperty(Q.prototype, 'invalidCallback', {
    get: function() {
      return P
    },
    set: function(a) {
  ...
  var T = null,
    ta = (window.HTMLImports && window.HTMLImports.whenReady) || null,
    U
  function ua(a) {
  ...
  W.prototype.prepareTemplate = function(a, c) {
    X(this)
    k[c] = a
    c = V.m(a, c)
    a._styleAst = c
  ...
  W.prototype.styleSubtree = function(a, c) {
    X(this)
    if (c)
      for (var b in c)
  ...
  W.prototype.styleElement = function(a) {
    ...
    c
      ...
      : (b = a.is)
    if ((c = k[b]) && !A(c)) {
      if (A(c) || c._applyShimValidatingVersion !== c._applyShimNextVersion)
        this.prepareTemplate(c, b), ma(c)
      if ((a = a.shadowRoot))
        if ((a = a.querySelector('style')))
          (a.__cssRules = c._styleAst), (a.textContent = J(c._styleAst))
    }
  }
