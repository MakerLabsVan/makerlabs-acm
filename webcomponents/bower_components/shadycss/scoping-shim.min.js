...
*/
  ...
  function J(a, b, c) {
    var e = K
    a.__styleScoped ? (a.__styleScoped = null) : Fa(e, a, b || '', c)
  }
  function Fa(a, b, c, e) {
    b.nodeType === Node.ELEMENT_NODE && Ga(b, c, e)
    if (
      (b =
        'template' === b.localName
          ? (b.content || b.R).childNodes
          : b.children || b.childNodes)
    )
      for (var d = 0; d < b.length; d++) Fa(a, b[d], c, e)
  }
  function Ga(a, b, c) {
    if (b)
      if (a.classList)
  ...
  function Ia(a, b, c, e, d) {
    ...
    return z(b, function(b) {
      b.c || ((b.selector = b.g = N(a, b, a.b, c, f)), (b.c = !0))
      d && d(b, c, f)
    })
  }
  function M(a, b) {
  ...
  function La(a) {
    return a.replace(Ma, function(a, c, e) {
      ;-1 < e.indexOf('+')
        ? (e = e.replace(/\+/g, '___'))
  ...
  I.prototype.b = function(a, b, c) {
    ...
    var d = Ma.test(a)
    d &&
      ((a = a.replace(Ma, function(a, b, c) {
        return ':' + b + '(' + c.replace(/\s/g, '') + ')'
      })),
      (a = La(a)))
    a = a.replace(Na, Oa + ' $1')
    a = a.replace(Pa, function(a, d, g) {
      e || ((a = Qa(g, d, b, c)), (e = e || a.stop), (d = a.H), (g = a.value))
      return d + g
    })
    d && (a = La(a))
    return a
  ...
  function Qa(a, b, c, e) {
    var d = a.indexOf(Ra)
    0 <= a.indexOf(Oa) ? (a = Sa(a, e)) : 0 !== d && (a = c ? Ta(a, c) : a)
    c = !1
    0 <= d && ((b = ''), (c = !0))
    if (c) {
      var f = !0
      c &&
        (a = a.replace(Ua, function(a, b) {
          return ' > ' + b
        }))
    }
    a = a.replace(Va, function(a, b, c) {
  ...
  function $a(a) {
    a.selector === ab && (a.selector = 'html')
  }
  I.prototype.c = function(a) {
    return a.match(Ra) ? this.b(a, bb) : Ta(a.trim(), bb)
  }
            ...
            if ((h = -1 < g ? h[g + 1] : '') && f === d.ownerDocument)
              ...
              if (((f = F(f).is), h === f))
                for (
                  ...
                  Ga(d[f], h)
              else h && J(d, h, !0), J(d, f)
          }
        }
    }
  }
  if (!t) {
    var eb = new MutationObserver(db),
      fb = function(a) {
        eb.observe(a, { childList: !0, subtree: !0 })
      }
    if (
      ...
      window.HTMLImports
        ? window.HTMLImports.whenReady(gb)
        : requestAnimationFrame(function() {
  ...
  var kb = navigator.userAgent.match('Trident')
  function lb() {}
  function mb(a) {
    var b = {},
      c = [],
  ...
  function pb(a, b, c, e, d) {
    ...
    if (c.f.i) {
      ...
      'shady' === e &&
        ...
        (g = !h && 0 === f.indexOf(b)))
      'shadow' === e && ((h = ':host > *' === f || 'html' === f), (g = g && !h))
      if (h || g)
        (e = b),
          g &&
            (c.g || (c.g = N(K, c, K.b, a ? Ja + a : '', b)), (e = c.g || b)),
          d({ M: e, K: g, S: h })
    }
  }
  function qb(a, b) {
    ...
    A(
      b,
      function(b) {
        pb(d, a, b, f, function(d) {
          jb.call(a.A || a, d.M) && (d.K ? S(b, c) : S(b, e))
        })
      },
      null,
      !0
  ...
  function rb(a, b, c, e) {
    ...
    return L(b, d, function(b) {
      var d = ''
      b.f || R(b)
      b.f.cssText && (d = nb(a, b.f.cssText, c))
      b.cssText = d
      if (!t && !Aa(b) && b.cssText) {
        var k = (d = b.cssText)
        null == b.C && (b.C = wa.test(d))
        if (b.C)
          if (null == b.w) {
            b.w = []
            for (var q in g)
              (k = g[q]), (k = k(d)), d !== k && ((d = k), b.w.push(q))
          } else {
            for (q = 0; q < b.w.length; ++q) (k = g[b.w[q]]), (d = k(d))
            k = d
          }
        b.cssText = k
        b.g = b.g || b.selector
        ...
        q = b.g.split(',')
        k = 0
        for (var yb = q.length, O; k < yb && (O = q[k]); k++)
  ...
  function ub(a, b) {
    ...
    a.textContent = z(e, function(a) {
      ...
      a.f &&
        a.f.cssText &&
        ((d = d.replace(ma, '').replace(na, '')), (a.cssText = nb(c, d, b)))
    })
  }
  aa.Object.defineProperties(lb.prototype, {
    a: {
      configurable: !0,
      enumerable: !0,
      get: function() {
    ...
    if (this.b) {
      ...
      if (this.b.enqueued) {
        if (v)
          ...
          for (zb(this, this.c, this.l), b = 0; b < a.length; b++)
            (c = this.b.getStyleForCustomStyle(a[b])) && ub(c, this.l.m)
        this.b.enqueued = !1
        this.v && !v && this.styleDocument()
      }
    }
  }
  l.styleElement = function(a, b) {
    ...
    if (!e) {
      ...
      e = ib(a, new P(h, f, g, 0, d))
    }
    a !== this.c && (this.v = !0)
    b && ((e.s = e.s || {}), Object.assign(e.s, b))
    if (v) {
      if (e.s) {
        b = e.s
        for (var k in b)
      ...
      if (((k = m[c]) || a === this.c) && k && k.a && !sa(k)) {
        if (sa(k) || k._applyShimValidatingVersion !== k._applyShimNextVersion)
          Y(this),
            ...
            (k.a.textContent = L(a, e.j)),
            ta(k)
        t &&
          (c = a.shadowRoot) &&
          (c.querySelector('style').textContent = L(a, e.j))
        e.j = k._styleAst
      }
    } else if ((zb(this, a, e), e.B && e.B.length)) {
      c = e
      k = F(a).is
      a: {
        if ((b = W.cache[k]))
      ...
      h = c.h
      ;(g = b && b.h) ||
        ((g = this.A[k] = (this.A[k] || 0) + 1), (g = k + '-' + g))
      c.h = g
      g = c.h
      d = U
      d = e ? e.textContent || '' : rb(d, a, c.m, g)
      f = Q(a)
      var x = f.a
      x &&
        !t &&
      ...
      t
        ...
        : e
          ? e.parentNode ||
            (kb && -1 < d.indexOf('@media') && (e.textContent = d),
            Ba(e, null, f.b))
          : d && (e = C(d, g, null, f.b))
      e &&
        ((e._useCount = e._useCount || 0), f.a != e && e._useCount++, (f.a = e))
      g = e
      t ||
        ((e = c.h),
  ...
  function Ab(a, b) {
    return (b = b.getRootNode().host) ? (Q(b) ? b : Ab(a, b)) : a.c
  }
  function zb(a, b, c) {
    a = Ab(a, b)
    var e = Q(a)
  ...
  l.D = function(a) {
    ...
    A(c, function(a) {
      if (t) $a(a)
        ...
        $a(a)
        a.selector = a.g = N(c, a, c.c, void 0, void 0)
      }
  ...
  X.prototype.setElementClass = X.prototype.N
  X.prototype._styleInfoForNode = X.prototype.G
  X.prototype.transformCustomStyleForDocument = X.prototype.D
  X.prototype.getStyleAst = X.prototype.I
  X.prototype.styleAstToString = X.prototype.O
  X.prototype.flushCustomStyles = X.prototype.o
  ...
  var Z = new X(),
    ...
    Cb
  window.ShadyCSS &&
    ((Bb = window.ShadyCSS.ApplyShim),
    (Cb = window.ShadyCSS.CustomStyleInterface))
  window.ShadyCSS = {
    ScopingShim: Z,
  ...
  Bb && (window.ShadyCSS.ApplyShim = Bb)
  Cb && (window.ShadyCSS.CustomStyleInterface = Cb)
}.call(this))
