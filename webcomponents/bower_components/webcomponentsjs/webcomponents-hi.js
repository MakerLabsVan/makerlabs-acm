  ...
  ;(function(h) {
    ...
    var N = /(url\()([^)]*)(\))/g,
      ...
      e = {
        ...
        o: function(a, b, c) {
          return a.replace(c, function(a, c, m, g) {
            a = m.replace(/["']/g, '')
            b && (a = e.c(a, b))
            return c + "'" + a + "'" + g
          })
    ...
    k.prototype.B = function(a, b) {
      ...
      x &&
        (a = a.replace(P, function(a, b, c) {
          return -1 === a.indexOf('type=') ? b + ' type=import-disable ' + c : a
        }))
      var c = document.createElement('template')
      c.innerHTML = a
      if (c.content) (a = c.content), E(a)
      else
    ...
    var z = null
    if (w)
      g(l(document, 'link[rel=import]'), function(a) {
        ...
        document.addEventListener('load', p, !0),
        document.addEventListener('error', p, !0)
    else {
      var q = Object.getOwnPropertyDescriptor(Node.prototype, 'baseURI')
      Object.defineProperty(
        (!q || q.configurable ? Node : Element).prototype,
        'baseURI',
        {
          get: function() {
...
*/
  var u = window.customElements,
    v = window.HTMLImports,
    A = window.HTMLTemplateElement
