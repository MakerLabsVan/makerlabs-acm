...
* @return {void}
*/
Polymer_PropertiesChanged.prototype._createPropertyAccessor = function(
  property,
  readOnly
) {}
/**
 * @param {string} property Name of the property
 */
Polymer_PropertiesChanged.prototype._addPropertyToAttributeMap = function(
  property
) {}
/**
 * @param {string} property Name of the property
 ...
 * @return {void}
 */
Polymer_PropertiesChanged.prototype._definePropertyAccessor = function(
  property,
  readOnly
) {}
/**
...
* @return {void}
*/
Polymer_PropertiesChanged.prototype._initializeInstanceProperties = function(
  props
) {}
/**
 * @param {string} property Name of the property
 ...
 * @return {boolean}
 */
Polymer_PropertiesChanged.prototype._setPendingProperty = function(
  property,
  value,
  ext
) {}
...
* @return {boolean}
*/
Polymer_PropertiesChanged.prototype._shouldPropertiesChange = function(
  currentProps,
  changedProps,
  oldProps
) {}
...
* @return {void}
*/
Polymer_PropertiesChanged.prototype._propertiesChanged = function(
  currentProps,
  changedProps,
  oldProps
) {}
 ...
 * @return {boolean}
 */
Polymer_PropertiesChanged.prototype._shouldPropertyChange = function(
  property,
  value,
  old
) {}
 ...
 * @return {void}
 */
Polymer_PropertiesChanged.prototype.attributeChangedCallback = function(
  name,
  old,
  value
) {}
...
* @return {void}
*/
Polymer_PropertiesChanged.prototype._attributeToProperty = function(
  attribute,
  value,
  type
) {}
 ...
 * @return {void}
 */
Polymer_PropertiesChanged.prototype._propertyToAttribute = function(
  property,
  attribute,
  value
) {}
 ...
 * @return {void}
 */
Polymer_PropertiesChanged.prototype._valueToNodeAttribute = function(
  node,
  value,
  attribute
) {}
...
* @return {void}
*/
Polymer_PropertyAccessors.prototype._definePropertyAccessor = function(
  property,
  readOnly
) {}
/**
...
* @return {void}
*/
Polymer_PropertyAccessors.prototype._initializeProtoProperties = function(
  props
) {}
/**
 ...
 * @return {void}
 */
Polymer_PropertyAccessors.prototype._ensureAttribute = function(
  attribute,
  value
) {}
/**
...
* @return {Function}
*/
Polymer_TemplateStamp.prototype._addMethodEventListenerToNode = function(
  node,
  eventName,
  methodName,
  context
 ...
 * @return {void}
 */
Polymer_TemplateStamp.prototype._addEventListenerToNode = function(
  node,
  eventName,
  handler
) {}
 ...
 * @return {void}
 */
Polymer_TemplateStamp.prototype._removeEventListenerFromNode = function(
  node,
  eventName,
  handler
) {}
 ...
 * @param {*} nodeInfo
 */
Polymer_TemplateStamp._parseTemplateContent = function(
  template,
  templateInfo,
  nodeInfo
) {}
 ...
 * @return {boolean}
 */
Polymer_TemplateStamp._parseTemplateNode = function(
  node,
  templateInfo,
  nodeInfo
) {}
 ...
 * @return {void}
 */
Polymer_TemplateStamp._parseTemplateChildNodes = function(
  root,
  templateInfo,
  nodeInfo
) {}
...
* @return {boolean}
*/
Polymer_TemplateStamp._parseTemplateNestedTemplate = function(
  node,
  outerTemplateInfo,
  nodeInfo
) {}
 ...
 * @return {boolean}
 */
Polymer_TemplateStamp._parseTemplateNodeAttributes = function(
  node,
  templateInfo,
  nodeInfo
) {}
 ...
 * @return {boolean}
 */
Polymer_TemplateStamp._parseTemplateNodeAttribute = function(
  node,
  templateInfo,
  nodeInfo,
  name,
 ...
 * @return {void}
 */
Polymer_PropertyEffects.prototype._initializeInstanceProperties = function(
  props
) {}
/**
 * @override
...
* @return {boolean}
*/
Polymer_PropertyEffects.prototype._setPendingProperty = function(
  property,
  value,
  shouldNotify
) {}
...
* @return {void}
*/
Polymer_PropertyEffects.prototype._propertiesChanged = function(
  currentProps,
  changedProps,
  oldProps
) {}
 ...
 * @return {void}
 */
Polymer_PropertyEffects.prototype._initializeProtoProperties = function(
  props
) {}
/**
 ...
 * @return {void}
 */
Polymer_PropertyEffects.prototype._addPropertyEffect = function(
  property,
  type,
  effect
) {}
 ...
 * @return {void}
 */
Polymer_PropertyEffects.prototype._removePropertyEffect = function(
  property,
  type,
  effect
) {}
 ...
 * @return {boolean}
 */
Polymer_PropertyEffects.prototype._hasPropertyEffect = function(
  property,
  type
) {}
/**
...
* @return {boolean}
*/
Polymer_PropertyEffects.prototype._setPendingPropertyOrPath = function(
  path,
  value,
  shouldNotify,
  isPathNotification
 ...
 * @return {void}
 */
Polymer_PropertyEffects.prototype._setUnmanagedPropertyToNode = function(
  node,
  prop,
  value
) {}
...
* @return {void}
*/
Polymer_PropertyEffects.prototype.setProperties = function(
  props,
  setReadOnly
) {}
/**
 ...
 * @return {void}
 */
Polymer_PropertyEffects.prototype._propagatePropertyChanges = function(
  changedProps,
  oldProps,
  hasPaths
) {}
 ...
 * @return {Array}
 */
Polymer_PropertyEffects.prototype.splice = function(
  path,
  start,
  deleteCount,
  items
...
* @return {void}
*/
Polymer_PropertyEffects.prototype._createReadOnlyProperty = function(
  property,
  protectedSetter
) {}
/**
...
* @return {void}
*/
Polymer_PropertyEffects.prototype._createPropertyObserver = function(
  property,
  method,
  dynamicFn
) {}
...
* @return {void}
*/
Polymer_PropertyEffects.prototype._createMethodObserver = function(
  expression,
  dynamicFn
) {}
/**
 ...
 * @return {void}
 */
Polymer_PropertyEffects.prototype._createNotifyingProperty = function(
  property
) {}
/**
 * @param {string} property Property name
 * @return {void}
 */
Polymer_PropertyEffects.prototype._createReflectedProperty = function(
  property
) {}
/**
...
* @return {void}
*/
Polymer_PropertyEffects.prototype._createComputedProperty = function(
  property,
  expression,
  dynamicFn
) {}
...
* @return {!TemplateInfo}
*/
Polymer_PropertyEffects.prototype._bindTemplate = function(
  template,
  instanceBinding
) {}
/**
 ...
 * @return {boolean}
 */
Polymer_PropertyEffects._parseTemplateNode = function(
  node,
  templateInfo,
  nodeInfo
) {}
 ...
 * @return {boolean}
 */
Polymer_PropertyEffects._parseTemplateNestedTemplate = function(
  node,
  templateInfo,
  nodeInfo
) {}
 ...
 * @return {boolean}
 */
Polymer_PropertyEffects._parseTemplateNodeAttribute = function(
  node,
  templateInfo,
  nodeInfo,
  name,
...
* @return {void}
*/
Polymer_PropertyEffects.createPropertyObserver = function(
  property,
  method,
  dynamicFn
) {}
 ...
 * @return {void}
 */
Polymer_PropertyEffects.createMethodObserver = function(
  expression,
  dynamicFn
) {}
/**
...
* @return {void}
*/
Polymer_PropertyEffects.createReadOnlyProperty = function(
  property,
  protectedSetter
) {}
/**
...
* @return {void}
*/
Polymer_PropertyEffects.createComputedProperty = function(
  property,
  expression,
  dynamicFn
) {}
 ...
 * @return {void}
 */
Polymer_PropertyEffects._addTemplatePropertyEffect = function(
  templateInfo,
  prop,
  effect
) {}
...
* @return {*}
*/
Polymer_PropertyEffects._evaluateBinding = function(
  inst,
  part,
  path,
  props,
 ...
 * @override
 */
Polymer_ElementMixin._parseTemplateContent = function(
  template,
  templateInfo,
  nodeInfo
) {}
 ...
 * @return {void}
 */
Polymer_GestureEventListeners.prototype._addEventListenerToNode = function(
  node,
  eventName,
  handler
) {}
 ...
 * @return {void}
 */
Polymer_GestureEventListeners.prototype._removeEventListenerFromNode = function(
  node,
  eventName,
  handler
) {}
 ...
 * @return {void}
 */
Polymer_LegacyElementMixin.prototype.attributeChangedCallback = function(
  name,
  old,
  value
) {}
 ...
 * @return {void}
 */
Polymer_LegacyElementMixin.prototype.reflectPropertyToAttribute = function(
  property,
  attribute,
  value
) {}
 ...
 * @return {void}
 */
Polymer_LegacyElementMixin.prototype.serializeValueToAttribute = function(
  value,
  attribute,
  node
) {}
...
* @return {Object}
*/
Polymer_LegacyElementMixin.prototype.chainObject = function(
  object,
  prototype
) {}
/**
 ...
 * @return {void}
 */
Polymer_LegacyElementMixin.prototype.listen = function(
  node,
  eventName,
  methodName
) {}
...
* @return {void}
*/
Polymer_LegacyElementMixin.prototype.unlisten = function(
  node,
  eventName,
  methodName
) {}
...
* @return {void}
*/
Polymer_LegacyElementMixin.prototype.setScrollDirection = function(
  direction,
  node
) {}
/**
 ...
 * @return {!Array.<!Node>}
 */
Polymer_LegacyElementMixin.prototype.queryDistributedElements = function(
  selector
) {}
/**
 * @return {!Array.<!Node>}
 ...
 * @return {Node}
 */
Polymer_LegacyElementMixin.prototype.queryEffectiveChildren = function(
  selector
) {}
/**
 * @param {string} selector Selector to run.
 * @return {!Array.<!Node>}
 */
Polymer_LegacyElementMixin.prototype.queryAllEffectiveChildren = function(
  selector
) {}
/**
 ...
 * @return {void}
 */
Polymer_LegacyElementMixin.prototype.scopeSubtree = function(
  container,
  shouldObserve
) {}
/**
 ...
 * @return {string}
 */
Polymer_LegacyElementMixin.prototype.getComputedStyleValue = function(
  property
) {}
/**
...
* @return {!Object}
*/
Polymer_LegacyElementMixin.prototype.debounce = function(
  jobName,
  callback,
  wait
) {}
...
*/
Polymer_LegacyElementMixin.prototype.importHref = function(
  href,
  onload,
  onerror,
  optAsync
 ...
 * @return {boolean}
 */
Polymer_LegacyElementMixin.prototype.elementMatches = function(
  selector,
  node
) {}
/**
...
* @return {void}
*/
Polymer_LegacyElementMixin.prototype.toggleAttribute = function(
  name,
  bool,
  node
) {}
...
* @return {void}
*/
Polymer_LegacyElementMixin.prototype.transform = function(
  transformText,
  node
) {}
/**
...
* @return {Array}
*/
Polymer_LegacyElementMixin.prototype.arrayDelete = function(
  arrayOrPath,
  item
) {}
/**
 ...
 * @return {boolean}
 */
Polymer_MutableData.prototype._shouldPropertyChange = function(
  property,
  value,
  old
) {}
 ...
 * @return {boolean}
 */
Polymer_OptionalMutableData.prototype._shouldPropertyChange = function(
  property,
  value,
  old
) {}
 ...
 * @override
 */
Polymer_DisableUpgradeMixin.prototype.attributeChangedCallback = function(
  name,
  old,
  value
) {}
