define(["./color.js","./shadow.js","./typography.js","../vaadin-button/src/vaadin-button.js"],function(){"use strict";const $_documentContainer=document.createElement("template");$_documentContainer.setAttribute("style","display: none;");$_documentContainer.innerHTML=`<dom-module id="material-button" theme-for="vaadin-button">
  <template>
    <style>
      :host {
        padding: 8px;
