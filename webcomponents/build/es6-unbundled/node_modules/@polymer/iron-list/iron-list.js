define(["../polymer/polymer-legacy.js","../iron-resizable-behavior/iron-resizable-behavior.js","../iron-a11y-keys-behavior/iron-a11y-keys-behavior.js","../iron-scroll-target-behavior/iron-scroll-target-behavior.js","../polymer/lib/utils/flush.js","../polymer/lib/utils/async.js","../polymer/lib/legacy/mutable-data-behavior.js","../polymer/lib/legacy/polymer-fn.js","../polymer/lib/utils/html-tag.js","../polymer/lib/legacy/templatizer-behavior.js","../polymer/lib/legacy/polymer.dom.js","../polymer/lib/utils/debounce.js","../polymer/lib/utils/path.js"],function(_polymerLegacy,_ironResizableBehavior,_ironA11yKeysBehavior,_ironScrollTargetBehavior,_flush,_async,_mutableDataBehavior,_polymerFn,_htmlTag,_templatizerBehavior,_polymerDom,_debounce,_path){"use strict";var _Mathfloor=Math.floor,_Mathround=Math.round,_Mathabs=Math.abs,_Mathceil=Math.ceil,_Mathmin=Math.min,_Mathmax=Math.max,IOS=navigator.userAgent.match(/iP(?:hone|ad;(?: U;)? CPU) OS (\d+)/),IOS_TOUCH_SCROLLING=IOS&&8<=IOS[1],DEFAULT_PHYSICAL_COUNT=3,HIDDEN_Y="-10000px",SECRET_TABINDEX=-100,IS_V2=null!=_flush.flush,ANIMATION_FRAME=IS_V2?_async.animationFrame:0,IDLE_TIME=IS_V2?_async.idlePeriod:1,MICRO_TASK=IS_V2?_async.microTask:2;if(!_mutableDataBehavior.OptionalMutableDataBehavior){Polymer.OptionalMutableDataBehavior={}}(0,_polymerFn.Polymer)({_template:_htmlTag.html`
    <style>
      :host {
        display: block;
      }
