...
</dom-module>`;document.head.appendChild($_documentContainer$1.content);Polymer$1({_template:html`
    <style>
      :host {
        @apply --layout-inline;
...
</iron-iconset-svg>`;document.head.appendChild($_documentContainer$2.content);Polymer$1({_template:html`
    <style>
      :host {
        display: inline-block;
        overflow: hidden;
...
</custom-style>`;document.head.appendChild($_documentContainer$3.content);const $_documentContainer$4=document.createElement("template");$_documentContainer$4.setAttribute("style","display: none;");$_documentContainer$4.innerHTML=`<dom-module id="paper-material-styles">
  <template>
    <style>
      :host, html {
        --paper-material: {
...
</dom-module>`;document.head.appendChild($_documentContainer$4.content);const $_documentContainer$5=document.createElement("template");$_documentContainer$5.setAttribute("style","display: none;");$_documentContainer$5.innerHTML=`<custom-style>
  <style is="custom-style">
    html {
...
</custom-style>`;document.head.appendChild($_documentContainer$5.content);const $_documentContainer$6=document.createElement("template");$_documentContainer$6.setAttribute("style","display: none;");$_documentContainer$6.innerHTML=`<custom-style>
  <style is="custom-style">
    html {
      /*
...
</custom-style>`;document.head.appendChild($_documentContainer$6.content);Polymer$1({_template:html`
    ...
    <slot></slot>
`,is:"paper-card",properties:{heading:{type:String,value:"",observer:"_headingChanged"},image:{type:String,value:""},alt:{type:String},preloadImage:{type:Boolean,value:!1},fadeImage:{type:Boolean,value:!1},placeholderImage:{type:String,value:null},elevation:{type:Number,value:1,reflectToAttribute:!0},animatedShadow:{type:Boolean,value:!1},animated:{type:Boolean,reflectToAttribute:!0,readOnly:!0,computed:"_computeAnimated(animatedShadow)"}},_isHidden:function(image){return image?"false":"true"},_headingChanged:function(heading){var currentHeading=this.getAttribute("heading"),currentLabel=this.getAttribute("aria-label");if("string"!==typeof currentLabel||currentLabel===currentHeading){this.setAttribute("aria-label",heading)}},_computeHeadingClass:function(image){return image?" over-image":""},_computeAnimated:function(animatedShadow){return animatedShadow}});const $_documentContainer$7=document.createElement("template");$_documentContainer$7.setAttribute("style","display: none;");$_documentContainer$7.innerHTML=`<dom-module id="paper-checkbox">
...
</custom-style>`;document.head.appendChild($_documentContainer$11.content);Polymer$1({_template:html`
    <style>
      :host {
        display: block;
        padding: 8px 0;
...
`,is:"paper-input-container",properties:{noLabelFloat:{type:Boolean,value:!1},alwaysFloatLabel:{type:Boolean,value:!1},attrForValue:{type:String,value:"bind-value"},autoValidate:{type:Boolean,value:!1},invalid:{observer:"_invalidChanged",type:Boolean,value:!1},focused:{readOnly:!0,type:Boolean,value:!1,notify:!0},_addons:{type:Array},_inputHasContent:{type:Boolean,value:!1},_inputSelector:{type:String,value:"input,iron-input,textarea,.paper-input-input"},_boundOnFocus:{type:Function,value:function(){return this._onFocus.bind(this)}},_boundOnBlur:{type:Function,value:function(){return this._onBlur.bind(this)}},_boundOnInput:{type:Function,value:function(){return this._onInput.bind(this)}},_boundValueChanged:{type:Function,value:function(){return this._onValueChanged.bind(this)}}},listeners:{"addon-attached":"_onAddonAttached","iron-input-validate":"_onIronInputValidate"},get _valueChangedEvent(){return this.attrForValue+"-changed"},get _propertyForValue(){return dashToCamelCase(this.attrForValue)},get _inputElement(){return dom(this).querySelector(this._inputSelector)},get _inputElementValue(){return this._inputElement[this._propertyForValue]||this._inputElement.value},ready:function(){this.__isFirstValueUpdate=!0;if(!this._addons){this._addons=[]}this.addEventListener("focus",this._boundOnFocus,!0);this.addEventListener("blur",this._boundOnBlur,!0)},attached:function(){if(this.attrForValue){this._inputElement.addEventListener(this._valueChangedEvent,this._boundValueChanged)}else{this.addEventListener("input",this._onInput)}if(this._inputElementValue&&""!=this._inputElementValue){this._handleValueAndAutoValidate(this._inputElement)}else{this._handleValue(this._inputElement)}},_onAddonAttached:function(event){if(!this._addons){this._addons=[]}var target=event.target;if(-1===this._addons.indexOf(target)){this._addons.push(target);if(this.isAttached){this._handleValue(this._inputElement)}}},_onFocus:function(){this._setFocused(!0)},_onBlur:function(){this._setFocused(!1);this._handleValueAndAutoValidate(this._inputElement)},_onInput:function(event){this._handleValueAndAutoValidate(event.target)},_onValueChanged:function(event){var input=event.target;if(this.__isFirstValueUpdate){this.__isFirstValueUpdate=!1;if(input.value===void 0||""===input.value){return}}this._handleValueAndAutoValidate(event.target)},_handleValue:function(inputElement){var value=this._inputElementValue;if(value||0===value||"number"===inputElement.type&&!inputElement.checkValidity()){this._inputHasContent=!0}else{this._inputHasContent=!1}this.updateAddons({inputElement:inputElement,value:value,invalid:this.invalid})},_handleValueAndAutoValidate:function(inputElement){if(this.autoValidate&&inputElement){var valid;if(inputElement.validate){valid=inputElement.validate(this._inputElementValue)}else{valid=inputElement.checkValidity()}this.invalid=!valid}this._handleValue(inputElement)},_onIronInputValidate:function(){this.invalid=this._inputElement.invalid},_invalidChanged:function(){if(this._addons){this.updateAddons({invalid:this.invalid})}},updateAddons:function(state){for(var addon,index=0;addon=this._addons[index];index++){addon.update(state)}},_computeInputContentClass:function(noLabelFloat,alwaysFloatLabel,focused,invalid,_inputHasContent){var cls="input-content";if(!noLabelFloat){var label=this.querySelector("label");if(alwaysFloatLabel||_inputHasContent){cls+=" label-is-floating";this.$.labelAndInputContainer.style.position="static";if(invalid){cls+=" is-invalid"}else if(focused){cls+=" label-is-highlighted"}}else{if(label){this.$.labelAndInputContainer.style.position="relative"}if(invalid){cls+=" is-invalid"}}}else{if(_inputHasContent){cls+=" label-is-hidden"}if(invalid){cls+=" is-invalid"}}if(focused){cls+=" focused"}return cls},_computeUnderlineClass:function(focused,invalid){var cls="underline";if(invalid){cls+=" is-invalid"}else if(focused){cls+=" is-highlighted"}return cls},_computeAddOnContentClass:function(focused,invalid){var cls="add-on-content";if(invalid){cls+=" is-invalid"}else if(focused){cls+=" is-highlighted"}return cls}});Polymer$1({_template:html`
    ...
    <slot></slot>
`,is:"paper-input-error",behaviors:[PaperInputAddonBehavior],properties:{invalid:{readOnly:!0,reflectToAttribute:!0,type:Boolean}},update:function(state){this._setInvalid(state.invalid)}});const $_documentContainer$12=document.createElement("template");$_documentContainer$12.setAttribute("style","display: none;");$_documentContainer$12.innerHTML=`<dom-module id="paper-input">
  <template>
    <style>
      :host {
        display: block;
...
</dom-module>`;document.head.appendChild($_documentContainer$13.content);Polymer$1({is:"paper-fab",behaviors:[PaperButtonBehavior],properties:{src:{type:String,value:""},icon:{type:String,value:""},mini:{type:Boolean,value:!1,reflectToAttribute:!0},label:{type:String,observer:"_labelChanged"}},_labelChanged:function(){this.setAttribute("aria-label",this.label)},_computeIsIconFab:function(icon,src){return 0<icon.length||0<src.length}});const PaperItemBehaviorImpl={hostAttributes:{role:"option",tabindex:"0"}};_exports.PaperItemBehaviorImpl=PaperItemBehaviorImpl;const PaperItemBehavior=[IronButtonState,IronControlState,PaperItemBehaviorImpl];_exports.PaperItemBehavior=PaperItemBehavior;_exports.$paperItemBehavior={PaperItemBehaviorImpl:PaperItemBehaviorImpl,PaperItemBehavior:PaperItemBehavior};const $_documentContainer$14=document.createElement("template");$_documentContainer$14.setAttribute("style","display: none;");$_documentContainer$14.innerHTML=`<dom-module id="paper-item-shared-styles">
  <template>
    <style>
      :host, .paper-item {
        display: block;
...
</dom-module>`;document.head.appendChild($_documentContainer$14.content);Polymer$1({_template:html`
...
`,is:"paper-item",behaviors:[PaperItemBehavior]});Polymer$1({_template:html`
    ...
    <slot></slot>
`,is:"paper-listbox",behaviors:[IronMenuBehavior],hostAttributes:{role:"listbox"}});const $_documentContainer$15=document.createElement("template");$_documentContainer$15.setAttribute("style","display: none;");$_documentContainer$15.innerHTML=`<dom-module id="paper-material-shared-styles">
  <template>
    <style>
      :host {
        display: block;
...
</dom-module>`;document.head.appendChild($_documentContainer$15.content);Polymer$1({_template:html`
    ...
    <slot></slot>
`,is:"paper-material",properties:{elevation:{type:Number,reflectToAttribute:!0,value:1},animated:{type:Boolean,reflectToAttribute:!0,value:!1}}});const $_documentContainer$16=document.createElement("template");$_documentContainer$16.setAttribute("style","display: none;");$_documentContainer$16.innerHTML=`<dom-module id="paper-radio-button">
  <template strip-whitespace="">
    <style>
      :host {
        display: inline-block;
...
`}static get is(){return"vaadin-button"}static get version(){return"2.1.0-beta2"}ready(){super.ready();this.setAttribute("role","button");this.$.button.setAttribute("role","presentation");this._addActiveListeners()}disconnectedCallback(){super.disconnectedCallback();if(this.hasAttribute("active")){this.removeAttribute("active")}}_addActiveListeners(){addListener(this,"down",()=>!this.disabled&&this.setAttribute("active",""));addListener(this,"up",()=>this.removeAttribute("active"));this.addEventListener("keydown",e=>!this.disabled&&0<=[13,32].indexOf(e.keyCode)&&this.setAttribute("active",""));this.addEventListener("keyup",()=>this.removeAttribute("active"));this.addEventListener("blur",()=>this.removeAttribute("active"))}get focusElement(){return this.$.button}}_exports.ButtonElement=ButtonElement;customElements.define(ButtonElement.is,ButtonElement);_exports.$vaadinButton={ButtonElement:ButtonElement};class Material extends HTMLElement{static get version(){return"1.1.0-beta1"}}_exports.Material=Material;customElements.define("vaadin-material-styles",Material);_exports.$version={Material:Material};const $_documentContainer$18=document.createElement("template");$_documentContainer$18.innerHTML=`<dom-module id="material-color-light">
  <template>
    <style>
      :host {
        /* Text colors */
...
</custom-style>`;document.head.appendChild($_documentContainer$18.content);const $_documentContainer$19=document.createElement("template");$_documentContainer$19.innerHTML=`<custom-style>
  <style is="custom-style">
    html {
      /* from http://codepen.io/shyndman/pen/c5394ddf2e8b2a5c9185904b57421cdb */
...
</custom-style>`;document.head.appendChild($_documentContainer$19.content);const $_documentContainer$20=document.createElement("template");$_documentContainer$20.innerHTML=`<custom-style>
  <style>
    html {
      /* Font family */
...
</dom-module>`;document.head.appendChild($_documentContainer$20.content);const $_documentContainer$21=document.createElement("template");$_documentContainer$21.innerHTML=`<dom-module id="material-button" theme-for="vaadin-button">
  <template>
    <style>
      :host {
        padding: 8px;
...
</dom-module>`;document.head.appendChild($_documentContainer$21.content);class ComboBoxItemElement extends ThemableMixin(PolymerElement){static get template(){return html`
    <style>
      :host {
        display: block;
      }
...
</dom-module>`;document.head.appendChild($_documentContainer$23.content);const $_documentContainer$24=document.createElement("template");$_documentContainer$24.innerHTML=`<dom-module id="material-menu-overlay">
  <template>
    <style include="material-overlay">
    </style>
  </template>
</dom-module>`;document.head.appendChild($_documentContainer$24.content);const $_documentContainer$25=document.createElement("template");$_documentContainer$25.innerHTML=`<dom-module id="material-combo-box-overlay" theme-for="vaadin-combo-box-overlay">
  <template>
...
</dom-module>`;document.head.appendChild($_documentContainer$25.content);const $_documentContainer$26=document.createElement("template");$_documentContainer$26.innerHTML=`<custom-style>
  <style>
    @font-face {
...
</custom-style>`;document.head.appendChild($_documentContainer$26.content);const $_documentContainer$27=document.createElement("template");$_documentContainer$27.innerHTML=`<dom-module id="material-item" theme-for="vaadin-item">
  <template>
    <style>
      :host {
        display: flex;
...
`}static get is(){return"vaadin-item"}static get version(){return"2.1.0-beta2"}}_exports.ItemElement=ItemElement;customElements.define(ItemElement.is,ItemElement);_exports.$vaadinItem={ItemElement:ItemElement};const $_documentContainer$28=document.createElement("template");$_documentContainer$28.innerHTML=`<dom-module id="material-combo-box-item" theme-for="vaadin-combo-box-item">
  <template>
...
</dom-module>`;document.head.appendChild($_documentContainer$28.content);const $_documentContainer$29=document.createElement("template");$_documentContainer$29.innerHTML=`<dom-module id="material-text-field" theme-for="vaadin-text-field">
  <template>
    <style>
      :host {
        display: inline-flex;
...
</dom-module>`;document.head.appendChild($_documentContainer$29.content);const $_documentContainer$30=document.createElement("template");$_documentContainer$30.innerHTML=`<dom-module id="material-field-button">
  <template>
    <style>
...
</dom-module>`;document.head.appendChild($_documentContainer$30.content);const $_documentContainer$31=document.createElement("template");$_documentContainer$31.innerHTML=`<dom-module id="material-combo-box" theme-for="vaadin-combo-box">
  <template>
...
</dom-module>`;document.head.appendChild($_documentContainer$32.content);class DatePickerOverlayContentElement extends ThemableMixin(GestureEventListeners(PolymerElement)){static get template(){return html`
    <style>
      :host {
        display: flex;
        flex-direction: column;
...
`}static get is(){return"vaadin-date-picker-light"}static get properties(){return{attrForValue:{type:String,value:"bind-value"}}}_input(){return this.querySelector("vaadin-text-field,iron-input,paper-input,.paper-input-input,.input")}set _inputValue(value){if(this._inputElement){this._inputElement[dashToCamelCase(this.attrForValue)]=value}}get _inputValue(){return this._inputElement&&this._inputElement[dashToCamelCase(this.attrForValue)]}}_exports.DatePickerLightElement=DatePickerLightElement;customElements.define(DatePickerLightElement.is,DatePickerLightElement);_exports.$vaadinDatePickerLight={DatePickerLightElement:DatePickerLightElement};const $_documentContainer$33=document.createElement("template");$_documentContainer$33.innerHTML=`<dom-module id="material-date-picker-overlay" theme-for="vaadin-date-picker-overlay">
  <template>
    <style include="material-overlay">
      :host([fullscreen]) {
        top: 0 !important;
...
</dom-module>`;document.head.appendChild($_documentContainer$33.content);const $_documentContainer$34=document.createElement("template");$_documentContainer$34.innerHTML=`<dom-module id="material-date-picker-overlay-content" theme-for="vaadin-date-picker-overlay-content">
  <template>
    <style>
      :host {
        font-family: var(--material-font-family);
...
</dom-module>`;document.head.appendChild($_documentContainer$34.content);const $_documentContainer$35=document.createElement("template");$_documentContainer$35.innerHTML=`<dom-module id="material-date-picker-month-calendar" theme-for="vaadin-month-calendar">
  <template>
    <style>
      :host {
        color: var(--material-body-text-color);
...
</dom-module>`;document.head.appendChild($_documentContainer$37.content);var BrandValue={GOOGLE:"google",PLUS:"google-plus"},LabelValue={STANDARD:"Sign in",WIDE:"Sign in with Google",WIDE_PLUS:"Sign in with Google+"},WidthValue={ICON_ONLY:"iconOnly",STANDARD:"standard",WIDE:"wide"};Polymer$1({_template:html`
...
`,is:"google-signin",properties:{appPackageName:{type:String,value:""},brand:{type:String,value:""},_brand:{type:String,computed:"_computeBrand(brand, hasPlusScopes)"},clientId:{type:String,value:""},cookiePolicy:{type:String,value:""},height:{type:String,value:"standard"},fill:{type:Boolean,value:!0},labelAdditional:{type:String,value:"Additional permissions required"},labelSignin:{type:String,value:""},_labelSignin:{type:String,computed:"_computeSigninLabel(labelSignin, width, _brand)"},labelSignout:{type:String,value:"Sign out"},raised:{type:Boolean,value:!1},requestVisibleActions:{type:String,value:""},hostedDomain:{type:String,value:""},offline:{type:Boolean,value:!1},offlineAlwaysPrompt:{type:Boolean,value:!1},scopes:{type:String,value:""},openidPrompt:{type:String,value:""},theme:{type:String,value:"light"},width:{type:String,value:"standard"},_brandIcon:{type:String,computed:"_computeIcon(_brand)"},hasPlusScopes:{type:Boolean,notify:!0,value:!1},needAdditionalAuth:{type:Boolean,notify:!0,value:!1},initialized:{type:Boolean,notify:!0,value:!1},signedIn:{type:Boolean,notify:!0,value:!1,observer:"_observeSignedIn"},isAuthorized:{type:Boolean,notify:!0,value:!1}},_computeButtonClass:function(height,width,theme,signedIn,brand,needAdditionalAuth){return"height-"+height+" width-"+width+" theme-"+theme+" signedIn-"+signedIn+" brand-"+brand+"  additionalAuth-"+needAdditionalAuth},_computeIcon:function(brand){return"google:"+brand},_computeButtonIsSignIn:function(signedIn){return!signedIn},_computeButtonIsSignOut:function(signedIn,additionalAuth){return signedIn&&!additionalAuth},_computeButtonIsSignOutAddl:function(signedIn,additionalAuth){return signedIn&&additionalAuth},_computeBrand:function(attrBrand,hasPlusScopes){var newBrand;if(attrBrand){newBrand=attrBrand}else if(hasPlusScopes){newBrand=BrandValue.PLUS}else{newBrand=BrandValue.GOOGLE}return newBrand},_observeSignedIn:function(newVal,oldVal){if(newVal){if(this.needAdditionalAuth){this.fire("google-signin-necessary")}this.fire("google-signin-success")}else if(oldVal){this.fire("google-signed-out")}},_computeSigninLabel:function(labelSignin,width,_brand){if(labelSignin){return labelSignin}else{switch(width){case WidthValue.WIDE:return _brand==BrandValue.PLUS?LabelValue.WIDE_PLUS:LabelValue.WIDE;case WidthValue.STANDARD:return LabelValue.STANDARD;case WidthValue.ICON_ONLY:return"";default:console.warn("bad width value: ",width);return LabelValue.STANDARD;}}},signIn:function(){this.$.aware.signIn()},_signInKeyPress:function(e){if(13==e.which||13==e.keyCode||32==e.which||32==e.keyCode){e.preventDefault();this.signIn()}},signOut:function(){this.fire("google-signout-attempted");this.$.aware.signOut()},_signOutKeyPress:function(e){if(13==e.which||13==e.keyCode||32==e.which||32==e.keyCode){e.preventDefault();this.signOut()}}});!function(root,factory){if("object"===typeof module&&module.exports){module.exports=factory(root);module.exports["default"]=module.exports}else root.timeago=factory(root)}("undefined"!==typeof window?window:void 0,function(){var indexMapEn="second_minute_hour_day_week_month_year".split("_"),indexMapZh="\u79D2_\u5206\u949F_\u5C0F\u65F6_\u5929_\u5468_\u6708_\u5E74".split("_"),locales={en:function(number,index){if(0===index)return["just now","right now"];var unit=indexMapEn[parseInt(index/2)];if(1<number)unit+="s";return[number+" "+unit+" ago","in "+number+" "+unit]},zh_CN:function(number,index){if(0===index)return["\u521A\u521A","\u7247\u523B\u540E"];var unit=indexMapZh[parseInt(index/2)];return[number+unit+"\u524D",number+unit+"\u540E"]}},SEC_ARRAY=[60,60,24,7,365/7/12,12],SEC_ARRAY_LEN=6,ATTR_DATA_TID="data-tid",timers={};function toDate(input){if(input instanceof Date)return input;if(!isNaN(input))return new Date(toInt(input));if(/^\d+$/.test(input))return new Date(toInt(input));input=(input||"").trim().replace(/\.\d+/,"").replace(/-/,"/").replace(/-/,"/").replace(/(\d)T(\d)/,"$1 $2").replace(/Z/," UTC").replace(/([\+\-]\d\d)\:?(\d\d)/," $1$2");return new Date(input)}function toInt(f){return parseInt(f)}function formatDiff(diff,locale,defaultLocale){locale=locales[locale]?locale:locales[defaultLocale]?defaultLocale:"en";var i=0,agoin=0>diff?1:0,total_sec=diff=_Mathabs(diff);for(;diff>=SEC_ARRAY[i]&&i<SEC_ARRAY_LEN;i++){diff/=SEC_ARRAY[i]}diff=toInt(diff);i*=2;if(diff>(0===i?9:1))i+=1;return locales[locale](diff,i,total_sec)[agoin].replace("%s",diff)}function diffSec(date,nowDate){nowDate=nowDate?toDate(nowDate):new Date;return(nowDate-toDate(date))/1e3}function nextInterval(diff){var rst=1,i=0,d=_Mathabs(diff);for(;diff>=SEC_ARRAY[i]&&i<SEC_ARRAY_LEN;i++){diff/=SEC_ARRAY[i];rst*=SEC_ARRAY[i]}d=d%rst;d=d?rst-d:rst;return _Mathceil(d)}function getDateAttr(node){return getAttr(node,"data-timeago")||getAttr(node,"datetime")}function getAttr(node,name){if(node.getAttribute)return node.getAttribute(name);if(node.attr)return node.attr(name)}function setTidAttr(node,val){if(node.setAttribute)return node.setAttribute(ATTR_DATA_TID,val);if(node.attr)return node.attr(ATTR_DATA_TID,val)}function Timeago(nowDate,defaultLocale){this.nowDate=nowDate;this.defaultLocale=defaultLocale||"en"}Timeago.prototype.doRender=function(node,date,locale){var diff=diffSec(date,this.nowDate),self=this,tid;node.innerHTML=formatDiff(diff,locale,this.defaultLocale);timers[tid=setTimeout(function(){self.doRender(node,date,locale);delete timers[tid]},_Mathmin(1e3*nextInterval(diff),2147483647))]=0;setTidAttr(node,tid)};Timeago.prototype.format=function(date,locale){return formatDiff(diffSec(date,this.nowDate),locale,this.defaultLocale)};Timeago.prototype.render=function(nodes,locale){if(nodes.length===void 0)nodes=[nodes];for(var i=0,len=nodes.length;i<len;i++){this.doRender(nodes[i],getDateAttr(nodes[i]),locale)}};Timeago.prototype.setLocale=function(locale){this.defaultLocale=locale};function timeagoFactory(nowDate,defaultLocale){return new Timeago(nowDate,defaultLocale)}timeagoFactory.register=function(locale,localeFunc){locales[locale]=localeFunc};timeagoFactory.cancel=function(node){if(node){tid=getAttr(node,ATTR_DATA_TID);if(tid){clearTimeout(tid);delete timers[tid]}}else{for(var tid in timers)clearTimeout(tid);timers={}}};return timeagoFactory});class UserSearchBar extends LitElement{static get properties(){return{items:{type:Array}}}constructor(){super();this.items=this.items||[]}_render(props){return html$2`
      ...
      `}handleSearchChanged(){const searchbox=this.shadowRoot.getElementById("searchbox");if(searchbox&&searchbox.selectedItem){this.dispatchEvent(new CustomEvent("search",{detail:babelHelpers.objectSpread({},searchbox.selectedItem)}))}}}customElements.define("user-search-bar",UserSearchBar);class ImageFileUploader extends LitElement{static get properties(){return{src:{type:String},emptyImageData:{type:String}}}constructor(){super();this.src=this.src||"data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=";this.emptyImageData=this.emptyImageData||"data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="}_render(props){return html$2`
      <style>
        #drop_zone {
          height: 200px;
      ...
      <form onsubmit="return false;" id="viewUserForm">
        ...
        <div class="mdc-layout-grid">
          <div class="mdc-layout-grid__inner">
            ${props.fields.map(section=>html$2`
                <paper-card
    ...
    `}renderField(field){if(this.fieldIsCheckboxType(field)){return html$2`
        <div>
          <paper-checkbox
            name="${field.name}"
            id="${field.name}"
      ...
      `}if(this.fieldIsRadioGroupType(field)){return html$2`
        <div>
          ...
          <paper-radio-group
            ...
            selected="0"
          >
            ${field.choices.map(choice=>html$2`
                <paper-radio-button
                  name="${choice}"
      ...
      `}if(this.fieldIsDropdownMenuType(field)){return html$2`
        <paper-dropdown-menu
          label="${field.title}"
          name="${field.name}"
          id="${field.name}"
      ...
      `}if(this.fieldIsDatePickerType(field)){return html$2`
      ...
      `}if(this.fieldIsImageType(field)){return html$2`
        <image-file-uploader
          id="${field.name}"
          name="${field.name}"
        ></image-file-uploader>
      `}if(this.fieldIsTextInputType(field)){return html$2`
        <paper-input
          always-float-label=""
          label="${field.title}"
          id="${field.name}"
          name="${field.name}"
        ></paper-input>
      `}if(this.fieldIsAlertsType(field)){return html$2`
        <paper-input
          always-float-label=""
          ...
          name="${field.name}"
        ></paper-input>
      `}if(this.fieldIsTagIdType(field)){return html$2`
        <vaadin-combo-box
          label="${field.title}"
          id="${field.name}"
          name="${field.name}"
      ...
      `}}get usersSheetName(){return"Users"}get usersSheetNumHeaders(){return 2}get activitySheetName(){return"Activity"}get activitySheetNumHeaders(){return 2}get hiddenSectionNames(){return["Initial","Hidden","Private"]}get usersRowColumn(){return this.usersColumnFromFieldTitle("Hidden","Row")}get usersNameColumn(){return this.usersColumnFromFieldTitle("Maker Info","Name")}get usersEmailColumn(){return this.usersColumnFromFieldTitle("Maker Info","Email")}get usersMakerLabsIdColumn(){return this.usersColumnFromFieldTitle("Membership Info","MakerLabs ID")}get usersAlertsColumn(){return this.usersColumnFromFieldTitle("Membership Info","Alerts")}get usersTagIdColumn(){return this.usersColumnFromFieldTitle("Access & Studio","Tag ID")}get activityTimestampColumn(){return"A"}get activityMachineIdColumn(){return"B"}get activityTypeColumn(){return"C"}get activityTagIdColumn(){return"E"}get activityMakerLabsIdColumn(){return"F"}sectionIsHidden(section){return section&&-1!=this.hiddenSectionNames.indexOf(section.title)}fieldIsCheckboxType(field){return"CHECKBOX"===field.type||"VALUE_IN_LIST"===field.type&&field.choices&&2==field.choices.length&&this.isNoLike(field.choices[0])&&this.isYesLike(field.choices[1])}fieldIsRadioGroupType(field){return"VALUE_IN_LIST"===field.type&&field.choices&&3>=field.choices.length&&!this.fieldIsCheckboxType(field)}fieldIsDropdownMenuType(field){return"VALUE_IN_LIST"===field.type&&field.choices&&3<field.choices.length}fieldIsDatePickerType(field){return"DATE_AFTER"==field.type||"DATE_BEFORE"==field.type||"DATE_BETWEEN"==field.type||"DATE_EQUAL_TO"==field.type||"DATE_IS_VALID_DATE"==field.type||"DATE_NOT_BETWEEN"==field.type||"DATE_ON_OR_AFTER"==field.type||"DATE_ON_OR_BEFORE"==field.type}fieldIsTextInputType(field){return!this.fieldIsTagIdType(field)&&!this.fieldIsAlertsType(field)&&(!field.type||"NUMBER_BETWEEN"==field.type||"NUMBER_EQUAL_TO"==field.type||"NUMBER_GREATER_THAN"==field.type||"NUMBER_GREATER_THAN_OR_EQUAL_TO"==field.type||"NUMBER_LESS_THAN"==field.type||"NUMBER_LESS_THAN_OR_EQUAL_TO"==field.type||"NUMBER_NOT_BETWEEN"==field.type||"NUMBER_NOT_EQUAL_TO"==field.type||"TEXT_CONTAINS"==field.type||"TEXT_DOES_NOT_CONTAIN"==field.type||"TEXT_EQUAL_TO"==field.type||"TEXT_IS_VALID_EMAIL"==field.type)}fieldIsAlertsType(field){return field.name===this.usersAlertsColumn}fieldIsTagIdType(field){return field.name===this.usersTagIdColumn}fieldIsImageType(field){return"TEXT_IS_VALID_URL"===field.type}usersColumnFromFieldTitle(prefixOrTitle,title){const prefix=title?prefixOrTitle:"";if(!title){title=prefixOrTitle}if(this.fields&&this.fields.length){for(var s=0,section;s<this.fields.length;++s){section=this.fields[s];for(var f=0,field;f<section.fields.length;++f){field=section.fields[f];if(prefix.length){var prefixStart=field.title.indexOf(prefix);if(0===prefixStart){var titleStart=field.title.indexOf(title,prefixStart+prefix.length+1);if(0===titleStart&&titleStart+title.length===field.length-1){return field.name}}}if(field.title==title){return field.name}}}}return null}handleUserNameChanged(newValue){var _this=this;return babelHelpers.asyncToGenerator(function*(){if(newValue){if(_this.usersNameColumn&&_this.userName){const datatable=yield _this.queryUsers(`where ${_this.usersNameColumn} = '${_this.userName}'`);var values=_this.getFirstRowValuesFromDatatable(datatable);if(values&&values.length){_this.showUserRow(values)}}}})()}_firstRendered(){var _this2=this;return babelHelpers.asyncToGenerator(function*(){var sheets=_this2.shadowRoot.getElementById("sheets");sheets.onSheetsApiLoaded=function(){console.log("onSheetsApiLoaded")};sheets.onSheetsApiLoadError=function(){console.log("onSheetsApiLoadError")};_this2.updateRecentTagIds();window.setInterval(_this2.updateRecentTagIds.bind(_this2),1e4)})()}updateFormFromMostRecentScan(){var _this3=this;return babelHelpers.asyncToGenerator(function*(){if(_this3.fields&&_this3.usersMakerLabsIdColumn){const datatable=yield _this3.queryActivity("select "+_this3.activityMakerLabsIdColumn+" where "+_this3.activityTypeColumn+" = 'Signed_In' and "+_this3.activityMachineIdColumn+" = '"+_this3.machineId+"' order by "+_this3.activityTimestampColumn+" desc limit 1");var activityValues=_this3.getValuesFromDatatable(datatable);if(activityValues&&activityValues.length){for(var makerLabsIdPrev="",rowIdx=0,makerLabsId;rowIdx<activityValues.length;rowIdx++){makerLabsId=activityValues[rowIdx][0]||"";if(makerLabsId!=makerLabsIdPrev){var didUpdateForm=_this3.updateFormFromMakerLabsId(makerLabsId);if(didUpdateForm){makerLabsIdPrev=makerLabsId}}}}}})()}updateFormFromMakerLabsId(makerLabsId){var _this4=this;return babelHelpers.asyncToGenerator(function*(){const datatable=yield _this4.queryUsers("where "+_this4.usersMakerLabsIdColumn+" = '"+makerLabsId+"'");var userValues=_this4.getFirstRowValuesFromDatatable(datatable);if(userValues&&userValues.length){_this4.showUserRow(userValues);return!0}return!1})()}updateRecentTagIds(){var _this5=this;return babelHelpers.asyncToGenerator(function*(){const el=_this5.shadowRoot.getElementById(_this5.usersTagIdColumn);if(el){const sinceTimestamp=Date.now()-1e3*(60*2),datatable=yield _this5.queryActivity("select "+_this5.activityTagIdColumn+",max("+_this5.activityMakerLabsIdColumn+"),max("+_this5.activityTimestampColumn+") where "+_this5.activityTimestampColumn+" > "+sinceTimestamp+" group by "+_this5.activityTagIdColumn+" limit 5");var items=[],values=_this5.getValuesFromDatatable(datatable);if(values){for(var rowIdx=0;rowIdx<values.length;rowIdx++){var tagId=values[rowIdx][0],makerLabsId=values[rowIdx][1],timestampMillis=values[rowIdx][2],timestamp=new Date(timestampMillis);if(!makerLabsId||0==makerLabsId.length){items.push({tagId,timestamp:timeago().format(timestamp)})}}el.items=items}}})()}getValuesFromDatatable(datatable,limit){var values=[];if(datatable&&datatable.table&&datatable.table.rows&&0<datatable.table.rows.length&&datatable.table.cols&&0<datatable.table.cols.length){limit=limit<datatable.table.rows.length?limit:datatable.table.rows.length;for(var rowIdx=0,rowValues;rowIdx<limit;rowIdx++){rowValues=[];for(var colIdx=0,v;colIdx<datatable.table.cols.length;colIdx++){v=datatable.table.rows[rowIdx].c[colIdx]&&datatable.table.rows[rowIdx].c[colIdx].v;rowValues.push(v)}values.push(rowValues)}}return values}getFirstRowValuesFromDatatable(datatable){const limitFirstRowValues=this.getValuesFromDatatable(datatable,1);return 0<limitFirstRowValues.length?limitFirstRowValues[0]:null}isYesLike(s){return-1!=["\u2611","Y","y","T","t","Yes","yes","True","true"].indexOf(s)}isNoLike(s){return-1!=["\u2610","N","n","F","f","No","no","False","false"].indexOf(s)}arraysEqual(a,b){if(a===b)return!0;if(null==a||null==b)return!1;if(a.length!=b.length)return!1;for(var i=0;i<a.length;++i){if(a[i]!==b[i])return!1}return!0}querySheet(sheetName,query,numHeaders=1){var queryString=encodeURIComponent(query);const responseHandlerName=`jsonp_${Date.now()}_${_Mathceil(1e5*Math.random())}`,query_url="https://docs.google.com/spreadsheets/d/"+this.sheetId+"/gviz/tq"+"?access_token="+this.accessToken+"&sheet="+sheetName+"&headers="+numHeaders+"&tq="+queryString+"&tqx=responseHandler:"+responseHandlerName;return fetchJsonp(query_url,{jsonpCallback:"responseHandler",jsonpCallbackFunction:responseHandlerName}).then(function(response){return response.json()}).catch(function(err){console.log("Parsing Google Visualization API response failed",err)})}queryUsers(query){return this.querySheet(this.usersSheetName,query,this.usersSheetNumHeaders)}queryActivity(query){return this.querySheet(this.activitySheetName,query,this.activitySheetNumHeaders)}resetValues(){this.showUserRow([])}populateNewUser(){this.showUserRow([]);this.populateNextMakerLabsId()}showUserObj(user){if(user.alerts){beep()}const nameField=this.fieldForColumnId(this.usersNameColumn);if(nameField&&user.name){this.updateField(nameField,user.name)}const emailField=this.fieldForColumnId(this.emailsNameColumn);if(emailField&&user.email){this.updateField(emailField,user.email)}const makerLabsIdField=this.fieldForColumnId(this.usersMakerLabsIdColumn);if(makerLabsIdField&&user.makerlabsId){this.updateField(makerLabsIdField,user.makerlabsId)}const alertsField=this.fieldForColumnId(this.usersAlertsColumn);if(alertsField&&user.alerts){this.updateField(alertsField,user.alerts)}const tagIdField=this.fieldForColumnId(this.usersTagIdColumn);if(tagIdField&&user.tagId){this.updateField(tagIdField,user.tagId)}}showUserRow(data){for(var i=0,s=0,section;s<this.fields.length;++s){section=this.fields[s];for(var f=0;f<section.fields.length;++f){var val=i<data.length?data[i++]:null,field=section.fields[f];this.updateField(field,val)}}}updateField(field,val){if(field.name){var el=this.shadowRoot.getElementById(field.name);if(!val){val=""}if(this.fieldIsCheckboxType(field)){el.checked=this.isYesLike(val[0])}else if(this.fieldIsRadioGroupType(field)){el.select(val)}else if(this.fieldIsDropdownMenuType(field)){var listbox=el.querySelector("paper-listbox"),selectedIdx=field.choices.indexOf(val);listbox.selected=0<=selectedIdx?selectedIdx:0}else if(this.fieldIsDatePickerType(field)||this.fieldIsTextInputType(field)||this.fieldIsAlertsType(field)||this.fieldIsTagIdType(field)){el.value=val}else if(this.fieldIsImageType(field)){var photoUrl=val||this.defaultPhotoUrl;el.src=photoUrl}else{console.log(`Unknown field name ${field.name}, type ${field.type}`)}}else{console.log(`Missing field name`)}}fieldForColumnId(columnId){for(var s=0,section;s<this.fields.length;++s){section=this.fields[s];for(var f=0,field;f<section.fields.length;++f){field=section.fields[f];if(field.name==columnId){return field}}}return null}populateNextMakerLabsId(){var _this6=this;return babelHelpers.asyncToGenerator(function*(){const response=yield fetch(_this6.nextMakerLabsIdUrl,{mode:"cors",credentials:"omit",headers:{Authorization:`Bearer ${_this6.accessToken}`}});if(200==response.status){const nextMakerLabsId=yield response.json(),makerLabsIdField=_this6.fieldForColumnId(_this6.usersMakerLabsIdColumn);if(makerLabsIdField){_this6.updateField(makerLabsIdField,nextMakerLabsId)}}else{console.log(`Fields JSON request fetch failed with response code: ${response.status}`)}})()}handleSubmit(){var _this7=this;return babelHelpers.asyncToGenerator(function*(){for(var sheets=_this7.shadowRoot.getElementById("sheets"),validTextFieldCount=0,formValues=[],s=0,section;s<_this7.fields.length;++s){section=_this7.fields[s];for(var f=0;f<section.fields.length;++f){var formValue,field=section.fields[f],el=_this7.shadowRoot.getElementById(field.name);if(el){if(_this7.fieldIsCheckboxType(field)){formValue=el.checked?field.choices[0]:field.choices[1]}else if(_this7.fieldIsRadioGroupType(field)){formValue=el.selected}else if(_this7.fieldIsDropdownMenuType(field)){formValue=el.value}else if(_this7.fieldIsDatePickerType(field)||_this7.fieldIsTextInputType(field)){formValue=el.value;if(formValue){validTextFieldCount++}}else if(_this7.fieldIsImageType(field)){if(el.src!=el.emptyImageData){formValue=el.src}}else if(_this7.fieldIsAlertsType(field)){formValue=el.value}else if(_this7.fieldIsTagIdType(field)){formValue=el.value}else{console.log(`Unknown field ${field.name}`)}}formValues.push(formValue)}}if(sheets&&sheets.api&&formValues.length){var rowName=formValues[0];if(rowName){formValues[0]=null;console.log(`Update '${_this7.usersSheetName}' row ${rowName}`);const response=yield sheets.api.spreadsheets.values.update({spreadsheetId:_this7.sheetId,range:`${_this7.usersSheetName}!A${rowName}`,majorDimension:"ROWS",valueInputOption:"USER_ENTERED",values:[formValues]});if(200==response.status){console.log(`Successfully updated '${_this7.usersSheetName}' row ${rowName}`)}else{console.log(`Invalid response received for updating '${_this7.usersSheetName}' ${response.status}`)}}else{if(0<validTextFieldCount){console.log(`Insert new '${_this7.usersSheetName}' row`);formValues[0]=null;const response=yield sheets.api.spreadsheets.values.append({spreadsheetId:_this7.sheetId,range:_this7.usersSheetName,valueInputOption:"USER_ENTERED",insertDataOption:"INSERT_ROWS",values:[formValues]});if(200==response.status){const appendResults=JSON.parse(response.body);if(appendResults&&appendResults.updates){const updatedRange=appendResults.updates.updatedRange,prefix=`${_this7.usersSheetName}!A`;if(updatedRange&&updatedRange.startsWith(prefix)){const newRowName=updatedRange.substr(prefix.length).split(":")[0];console.log(`Successfully created new User row ${newRowName}`);const rowField=_this7.fieldForColumnId(_this7.usersRowColumn);if(rowField){_this7.updateField(rowField,newRowName)}else{console.log(`Could not find Row column after creating User`)}}}}else{console.log(`Invalid response received for creating new User ${response.status}`)}console.log(response)}}}})()}}customElements.define("view-user-form",ViewUserForm);setPassiveTouchGestures(!0);setRootPath(MyAppGlobals.rootPath);class AppShell extends LitElement{static get properties(){return{sheetId:{type:String},machineId:{type:String},accessToken:{type:String},idToken:{type:String},oauthClientId:{type:String},oauthScopes:{type:String},fieldsUrl:{type:String},nextMakerLabsIdUrl:{type:String},_fields:{type:Array},userName:{type:String},usersSearchColumns:{type:String},defaultPhotoUrl:{type:String},query:{type:Object}}}_render(props){return html$2`
    <style>
      app-toolbar {
...
`}get fields(){return this._fields}set fields(fields){this._fieldsChanged(fields,this._fields);this._fields=fields}_fieldsChanged(newValue){var _this8=this;return babelHelpers.asyncToGenerator(function*(){if(newValue){const form=_this8.shadowRoot.getElementById("form");if(form){form.fields=newValue;var queryStr;if(form.query){if(form.query.Name){form.userName=form.query.Name;queryStr=`where ${form.usersNameColumn} = '${form.userName}'`}if(form.query["MakerLabs ID"]){const makerLabsId=form.query["MakerLabs ID"];queryStr=`where ${form.usersMakerLabsIdColumn} = '${makerLabsId}'`}if(queryStr&&queryStr.length){const datatable=yield form.queryUsers(queryStr);var values=form.getFirstRowValuesFromDatatable(datatable);if(values&&values.length){form.showUserRow(values)}}}const machinesDatatable=yield form.queryActivity("select max("+form.activityMachineIdColumn+") group by "+form.activityMachineIdColumn),machines=[];if(machinesDatatable&&machinesDatatable.table&&machinesDatatable.table.rows&&machinesDatatable.table.cols){for(var rowIdx=0;rowIdx<machinesDatatable.table.rows.length;rowIdx++){const colIdx=0,v=machinesDatatable.table.rows[rowIdx].c[colIdx]&&machinesDatatable.table.rows[rowIdx].c[colIdx].v;if(v){machines.push({type:"machine",style:"",secondaryStyle:"display: none;",imageStyle:"display: none;",iconStyle:"",Name:v})}}}const usersDatatable=yield form.queryUsers(`select ${_this8.usersSearchColumns}`),users=machines.slice(),sections=_this8.fields.map(section=>section.title);if(usersDatatable&&usersDatatable.table&&usersDatatable.table.rows&&usersDatatable.table.cols){for(var rowIdx=0,currentSection;rowIdx<usersDatatable.table.rows.length;rowIdx++){currentSection=0;const user={type:"user",style:"",secondaryStyle:"",imageStyle:"",iconStyle:"display: none;"};for(var colIdx=0,k;colIdx<usersDatatable.table.cols.length;colIdx++){k=usersDatatable.table.cols[colIdx].label;if(0===k.indexOf(sections[currentSection])){k=k.substr(sections[currentSection].length+1);currentSection++}k=k.replace(/\W/g,"_");const v=usersDatatable.table.rows[rowIdx].c[colIdx]&&usersDatatable.table.rows[rowIdx].c[colIdx].v;user[k]=v}if(!("Photo"in user)||!user.Photo){user.Photo=_this8.defaultPhotoUrl}if(user.Name){users.push(user)}}}const userSearchBar=_this8.shadowRoot.getElementById("search");if(userSearchBar){userSearchBar.items=users}}}})()}_firstRendered(){var _this9=this;const database=firebase.database(),aware=this.shadowRoot.querySelector("google-signin-aware");aware.handleAuthSignIn=this.handleAuthSignIn;aware.handleAuthSignOut=this.handleAuthSignOut;aware.handleAuthStateChange=this.handleAuthStateChange;const search=this.shadowRoot.getElementById("search"),form=this.shadowRoot.getElementById("form");search.addEventListener("search",function(){var _ref=babelHelpers.asyncToGenerator(function*(e){if(e.detail){const item=e.detail;switch(item.type){case"user":{if(_this9.onActivityCallback){const latestUserRef=database.ref(`readers/${_this9.machineId}/latestUser`);latestUserRef.off("value",_this9.onActivityCallback);_this9.onActivityCallback=null}form.resetValues();const row=parseInt(item.Row,10),datatable=yield form.queryUsers(`where A = ${row}`),values=form.getFirstRowValuesFromDatatable(datatable);if(values&&values.length){form.showUserRow(values)}break}case"machine":{_this9.machineId=item.Name;const latestUserRef=database.ref(`readers/${_this9.machineId}/latestUser`);if(_this9.pollActivityIntervalId){latestUserRef.off("value",_this9.onActivityCallback);_this9.onActivityCallback=null}form.resetValues();_this9.onActivityCallback=latestUserRef.on("value",function(data){const form=this.shadowRoot.getElementById("form"),user=data.toJSON();if(form&&user){const makerLabsId=user.makerlabsId;form.resetValues();form.showUserObj(user);form.updateFormFromMakerLabsId(makerLabsId)}}.bind(_this9))}}}});return function(){return _ref.apply(this,arguments)}}())}populateAuthTokens(){const authInstance="object"===typeof gapi&&gapi.auth2&&gapi.auth2.getAuthInstance();if(authInstance){const currentUser=authInstance&&authInstance.currentUser&&authInstance.currentUser.get();if(currentUser){const authResponse=currentUser.getAuthResponse(!0);if(authResponse){if("access_token"in authResponse){this.accessToken=authResponse.access_token}else{console.log("Could not find access_token in Google Sign-In response")}if("id_token"in authResponse){this.idToken=authResponse.id_token;this.loginFirebase()}else{console.log("Could not find id_token in Google Sign-In response")}}}}}fetchUserFields(){var _this10=this;return babelHelpers.asyncToGenerator(function*(){if(_this10.fieldsUrl&&0<_this10.fieldsUrl.length&&_this10.accessToken&&0<_this10.accessToken.length){const response=yield fetch(_this10.fieldsUrl,{mode:"cors",credentials:"omit",headers:{Authorization:`Bearer ${_this10.accessToken}`}});if(200==response.status){_this10.fields=yield response.json()}else{console.log(`Fields JSON request fetch failed with response code: ${response.status}`)}}})()}loginFirebase(){const googleAuthProvider=new firebase.auth.GoogleAuthProvider;var credential=googleAuthProvider.credential(this.idToken);firebase.auth().signInAndRetrieveDataWithCredential(credential).catch(function(error){var errorCode=error.code,errorMessage=error.message,email=error.email,credential=error.credential;if("auth/account-exists-with-different-credential"===errorCode){console.log("You have already signed up with a different auth provider for that email.")}else{console.error(error)}})}handleFirebaseAuthStateChange(){}handleAuthSignIn(){var _this11=this;return babelHelpers.asyncToGenerator(function*(){_this11.populateAuthTokens();setInterval(()=>{_this11.populateAuthTokens();console.log(`Updated accessToken`)},20*(1e3*60));_this11.fetchUserFields();firebase.auth().onAuthStateChanged(_this11.handleFirebaseAuthStateChange.bind(_this11))})()}handleAuthSignOut(){firebase.auth().signOut()}handleAuthStateChange(){}}customElements.define("app-shell",AppShell)});