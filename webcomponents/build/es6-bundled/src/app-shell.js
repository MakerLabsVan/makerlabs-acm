...
`}static get is(){return"vaadin-button"}static get version(){return"2.1.0-alpha3"}ready(){super.ready();this.setAttribute("role","button");this.$.button.setAttribute("role","presentation");this._addActiveListeners()}disconnectedCallback(){super.disconnectedCallback();if(this.hasAttribute("active")){this.removeAttribute("active")}}_addActiveListeners(){addListener(this,"down",()=>!this.disabled&&this.setAttribute("active",""));addListener(this,"up",()=>this.removeAttribute("active"));this.addEventListener("keydown",e=>!this.disabled&&0<=[13,32].indexOf(e.keyCode)&&this.setAttribute("active",""));this.addEventListener("keyup",()=>this.removeAttribute("active"));this.addEventListener("blur",()=>this.removeAttribute("active"))}get focusElement(){return this.$.button}}_exports.ButtonElement=ButtonElement;customElements.define(ButtonElement.is,ButtonElement);_exports.$vaadinButton={ButtonElement:ButtonElement};const Lumo={version:"1.0.0"};_exports.Lumo=Lumo;_exports.$version={Lumo:Lumo};const $_documentContainer$18=document.createElement("div");$_documentContainer$18.setAttribute("style","display: none;");$_documentContainer$18.innerHTML=`<custom-style>
  <style>
    html {
      /* Base (background) */
      --lumo-base-color: #FFF;
...
</dom-module>`;document.head.appendChild($_documentContainer$18);const $_documentContainer$19=document.createElement("div");$_documentContainer$19.setAttribute("style","display: none;");$_documentContainer$19.innerHTML=`<custom-style>
  <style>
    html {
...
</custom-style>`;document.head.appendChild($_documentContainer$19);const $_documentContainer$20=document.createElement("div");$_documentContainer$20.setAttribute("style","display: none;");$_documentContainer$20.innerHTML=`<custom-style>
  <style>
    html {
      /* Square */
...
</custom-style>`;document.head.appendChild($_documentContainer$20);const $_documentContainer$21=document.createElement("div");$_documentContainer$21.setAttribute("style","display: none;");$_documentContainer$21.innerHTML=`<custom-style>
  <style>
    html {
...
</custom-style>`;document.head.appendChild($_documentContainer$21);const $_documentContainer$22=document.createElement("div");$_documentContainer$22.setAttribute("style","display: none;");$_documentContainer$22.innerHTML=`<custom-style>
  <style>
    html {
      /* Font families */
...
</dom-module>`;document.head.appendChild($_documentContainer$22);const $_documentContainer$23=document.createElement("div");$_documentContainer$23.setAttribute("style","display: none;");$_documentContainer$23.innerHTML=`<dom-module id="lumo-button" theme-for="vaadin-button">
  <template>
    <style>
      :host {
        /* Sizing */
...
</dom-module>`;document.head.appendChild($_documentContainer$23);class Material extends HTMLElement{static get version(){return"1.1.0-alpha2"}}_exports.Material=Material;customElements.define("vaadin-material-styles",Material);_exports.$version$1={Material:Material};const $_documentContainer$24=document.createElement("div");$_documentContainer$24.setAttribute("style","display: none;");$_documentContainer$24.innerHTML=`<dom-module id="material-color-light">
  <template>
    <style>
      :host {
        /* Text colors */
...
</custom-style>`;document.head.appendChild($_documentContainer$24);const $_documentContainer$25=document.createElement("div");$_documentContainer$25.setAttribute("style","display: none;");$_documentContainer$25.innerHTML=`<custom-style>
  <style is="custom-style">
    html {
      /* from http://codepen.io/shyndman/pen/c5394ddf2e8b2a5c9185904b57421cdb */
...
</custom-style>`;document.head.appendChild($_documentContainer$25);const $_documentContainer$26=document.createElement("div");$_documentContainer$26.setAttribute("style","display: none;");$_documentContainer$26.innerHTML=`<custom-style>
  <style>
    html {
      /* Font family */
...
</dom-module>`;document.head.appendChild($_documentContainer$26);const $_documentContainer$27=document.createElement("div");$_documentContainer$27.setAttribute("style","display: none;");$_documentContainer$27.innerHTML=`<dom-module id="material-button" theme-for="vaadin-button">
  <template>
    <style>
      :host {
        padding: 8px;
...
</dom-module>`;document.head.appendChild($_documentContainer$27);class ComboBoxItemElement extends ThemableMixin(PolymerElement){static get template(){return html`
    <style>
      :host {
        display: block;
      }
...
</dom-module>`;document.head.appendChild($_documentContainer$29);const $_documentContainer$30=document.createElement("div");$_documentContainer$30.setAttribute("style","display: none;");$_documentContainer$30.innerHTML=`<dom-module id="lumo-vaadin-overlay" theme-for="vaadin-overlay">
  <template>
    <style include="lumo-overlay">
      /* stylelint-disable no-empty-source */
    </style>
  </template>
</dom-module>`;document.head.appendChild($_documentContainer$30);const $_documentContainer$31=document.createElement("div");$_documentContainer$31.setAttribute("style","display: none;");$_documentContainer$31.innerHTML=`<dom-module id="lumo-menu-overlay-core">
  <template>
    <style>
      :host([opening]),
      :host([closing]) {
...
</dom-module>`;document.head.appendChild($_documentContainer$31);const $_documentContainer$32=document.createElement("div");$_documentContainer$32.setAttribute("style","display: none;");$_documentContainer$32.innerHTML=`<dom-module id="lumo-combo-box-overlay" theme-for="vaadin-combo-box-overlay">
  <template>
    <style include="lumo-overlay lumo-menu-overlay-core">
      [part="content"] {
        padding: 0;
...
</dom-module>`;document.head.appendChild($_documentContainer$32);const $_documentContainer$33=document.createElement("div");$_documentContainer$33.setAttribute("style","display: none;");$_documentContainer$33.innerHTML=`<custom-style>
  <style>
    @font-face {
...
</custom-style>`;document.head.appendChild($_documentContainer$33);const $_documentContainer$34=document.createElement("div");$_documentContainer$34.setAttribute("style","display: none;");$_documentContainer$34.innerHTML=`<dom-module id="lumo-item" theme-for="vaadin-item">
  <template>
    <style>
      :host {
        display: flex;
...
`}static get is(){return"vaadin-item"}static get version(){return"2.1.0-alpha3"}}_exports.ItemElement=ItemElement;customElements.define(ItemElement.is,ItemElement);_exports.$vaadinItem={ItemElement:ItemElement};const $_documentContainer$35=document.createElement("div");$_documentContainer$35.setAttribute("style","display: none;");$_documentContainer$35.innerHTML=`<dom-module id="lumo-combo-box-item" theme-for="vaadin-combo-box-item">
  <template>
...
</dom-module>`;document.head.appendChild($_documentContainer$35);const $_documentContainer$36=document.createElement("div");$_documentContainer$36.setAttribute("style","display: none;");$_documentContainer$36.innerHTML=`<dom-module id="lumo-field-button">
  <template>
    <style>
      [part\$="button"] {
        flex: none;
...
</dom-module>`;document.head.appendChild($_documentContainer$36);const $_documentContainer$37=document.createElement("div");$_documentContainer$37.setAttribute("style","display: none;");$_documentContainer$37.innerHTML=`<dom-module id="lumo-text-field" theme-for="vaadin-text-field">
  <template>
    <style>
      :host {
...
</dom-module>`;document.head.appendChild($_documentContainer$37);const $_documentContainer$38=document.createElement("div");$_documentContainer$38.setAttribute("style","display: none;");$_documentContainer$38.innerHTML=`<dom-module id="lumo-combo-box" theme-for="vaadin-combo-box">
  <template>
...
</dom-module>`;document.head.appendChild($_documentContainer$38);const $_documentContainer$39=document.createElement("div");$_documentContainer$39.setAttribute("style","display: none;");$_documentContainer$39.innerHTML=`<dom-module id="material-overlay">
  <template>
    <style>
      :host {
        top: 16px;
...
</dom-module>`;document.head.appendChild($_documentContainer$39);const $_documentContainer$40=document.createElement("div");$_documentContainer$40.setAttribute("style","display: none;");$_documentContainer$40.innerHTML=`<dom-module id="material-menu-overlay">
  <template>
    <style include="material-overlay">
    </style>
  </template>
</dom-module>`;document.head.appendChild($_documentContainer$40);const $_documentContainer$41=document.createElement("div");$_documentContainer$41.setAttribute("style","display: none;");$_documentContainer$41.innerHTML=`<dom-module id="material-combo-box-overlay" theme-for="vaadin-combo-box-overlay">
  <template>
...
</dom-module>`;document.head.appendChild($_documentContainer$41);const $_documentContainer$42=document.createElement("div");$_documentContainer$42.setAttribute("style","display: none;");$_documentContainer$42.innerHTML=`<custom-style>
  <style>
    @font-face {
...
</custom-style>`;document.head.appendChild($_documentContainer$42);const $_documentContainer$43=document.createElement("div");$_documentContainer$43.setAttribute("style","display: none;");$_documentContainer$43.innerHTML=`<dom-module id="material-item" theme-for="vaadin-item">
  <template>
    <style>
      :host {
        display: flex;
...
</dom-module>`;document.head.appendChild($_documentContainer$43);const $_documentContainer$44=document.createElement("div");$_documentContainer$44.setAttribute("style","display: none;");$_documentContainer$44.innerHTML=`<dom-module id="material-combo-box-item" theme-for="vaadin-combo-box-item">
  <template>
...
</dom-module>`;document.head.appendChild($_documentContainer$44);const $_documentContainer$45=document.createElement("div");$_documentContainer$45.setAttribute("style","display: none;");$_documentContainer$45.innerHTML=`<dom-module id="material-text-field" theme-for="vaadin-text-field">
  <template>
    <style>
      :host {
        display: inline-flex;
...
</dom-module>`;document.head.appendChild($_documentContainer$45);const $_documentContainer$46=document.createElement("div");$_documentContainer$46.setAttribute("style","display: none;");$_documentContainer$46.innerHTML=`<dom-module id="material-field-button">
  <template>
    <style>
...
</dom-module>`;document.head.appendChild($_documentContainer$46);const $_documentContainer$47=document.createElement("div");$_documentContainer$47.setAttribute("style","display: none;");$_documentContainer$47.innerHTML=`<dom-module id="material-combo-box" theme-for="vaadin-combo-box">
  <template>
...
</dom-module>`;document.head.appendChild($_documentContainer$48);class DatePickerOverlayContentElement extends ThemableMixin(GestureEventListeners(PolymerElement)){static get template(){return html`
    <style>
      :host {
        display: flex;
        flex-direction: column;
...
</dom-module>`;document.head.appendChild($_documentContainer$49);const $_documentContainer$50=document.createElement("div");$_documentContainer$50.setAttribute("style","display: none;");$_documentContainer$50.innerHTML=`<dom-module id="lumo-date-picker-overlay-content" theme-for="vaadin-date-picker-overlay-content">
  <template>
    <style>
      :host {
        position: relative;
...
</dom-module>`;document.head.appendChild($_documentContainer$50);const $_documentContainer$51=document.createElement("div");$_documentContainer$51.setAttribute("style","display: none;");$_documentContainer$51.innerHTML=`<dom-module id="lumo-month-calendar" theme-for="vaadin-month-calendar">
  <template>
    <style>
      :host {
        -moz-user-select: none;
...
</custom-style>`;document.head.appendChild($_documentContainer$51);const $_documentContainer$52=document.createElement("div");$_documentContainer$52.setAttribute("style","display: none;");$_documentContainer$52.innerHTML=`<dom-module id="material-date-picker-overlay-content" theme-for="vaadin-date-picker-overlay-content">
  <template>
    <style>
      :host {
        font-family: var(--material-font-family);
...
</dom-module>`;document.head.appendChild($_documentContainer$52);const $_documentContainer$53=document.createElement("div");$_documentContainer$53.setAttribute("style","display: none;");$_documentContainer$53.innerHTML=`<dom-module id="material-date-picker-overlay" theme-for="vaadin-date-picker-overlay">
  <template>
    <style include="material-overlay">
      :host([fullscreen]) {
        top: 0 !important;
...
</dom-module>`;document.head.appendChild($_documentContainer$53);const $_documentContainer$54=document.createElement("div");$_documentContainer$54.setAttribute("style","display: none;");$_documentContainer$54.innerHTML=`<dom-module id="material-date-picker-month-calendar" theme-for="vaadin-month-calendar">
  <template>
    <style>
      :host {
        color: var(--material-body-text-color);
...
</dom-module>`;document.head.appendChild($_documentContainer$54);const $_documentContainer$55=document.createElement("div");$_documentContainer$55.setAttribute("style","display: none;");$_documentContainer$55.innerHTML=`<dom-module id="material-date-picker" theme-for="vaadin-date-picker">
  <template>
    <style include="material-field-button">
      :host {
        display: inline-flex;
...
</dom-module>`;document.head.appendChild($_documentContainer$57.content);var BrandValue={GOOGLE:"google",PLUS:"google-plus"},LabelValue={STANDARD:"Sign in",WIDE:"Sign in with Google",WIDE_PLUS:"Sign in with Google+"},WidthValue={ICON_ONLY:"iconOnly",STANDARD:"standard",WIDE:"wide"};Polymer$1({_template:html`
...
`,is:"google-signin",properties:{appPackageName:{type:String,value:""},brand:{type:String,value:""},_brand:{type:String,computed:"_computeBrand(brand, hasPlusScopes)"},clientId:{type:String,value:""},cookiePolicy:{type:String,value:""},height:{type:String,value:"standard"},fill:{type:Boolean,value:!0},labelAdditional:{type:String,value:"Additional permissions required"},labelSignin:{type:String,value:""},_labelSignin:{type:String,computed:"_computeSigninLabel(labelSignin, width, _brand)"},labelSignout:{type:String,value:"Sign out"},raised:{type:Boolean,value:!1},requestVisibleActions:{type:String,value:""},hostedDomain:{type:String,value:""},offline:{type:Boolean,value:!1},offlineAlwaysPrompt:{type:Boolean,value:!1},scopes:{type:String,value:""},openidPrompt:{type:String,value:""},theme:{type:String,value:"light"},width:{type:String,value:"standard"},_brandIcon:{type:String,computed:"_computeIcon(_brand)"},hasPlusScopes:{type:Boolean,notify:!0,value:!1},needAdditionalAuth:{type:Boolean,notify:!0,value:!1},initialized:{type:Boolean,notify:!0,value:!1},signedIn:{type:Boolean,notify:!0,value:!1,observer:"_observeSignedIn"},isAuthorized:{type:Boolean,notify:!0,value:!1}},_computeButtonClass:function(height,width,theme,signedIn,brand,needAdditionalAuth){return"height-"+height+" width-"+width+" theme-"+theme+" signedIn-"+signedIn+" brand-"+brand+"  additionalAuth-"+needAdditionalAuth},_computeIcon:function(brand){return"google:"+brand},_computeButtonIsSignIn:function(signedIn){return!signedIn},_computeButtonIsSignOut:function(signedIn,additionalAuth){return signedIn&&!additionalAuth},_computeButtonIsSignOutAddl:function(signedIn,additionalAuth){return signedIn&&additionalAuth},_computeBrand:function(attrBrand,hasPlusScopes){var newBrand;if(attrBrand){newBrand=attrBrand}else if(hasPlusScopes){newBrand=BrandValue.PLUS}else{newBrand=BrandValue.GOOGLE}return newBrand},_observeSignedIn:function(newVal,oldVal){if(newVal){if(this.needAdditionalAuth){this.fire("google-signin-necessary")}this.fire("google-signin-success")}else if(oldVal){this.fire("google-signed-out")}},_computeSigninLabel:function(labelSignin,width,_brand){if(labelSignin){return labelSignin}else{switch(width){case WidthValue.WIDE:return _brand==BrandValue.PLUS?LabelValue.WIDE_PLUS:LabelValue.WIDE;case WidthValue.STANDARD:return LabelValue.STANDARD;case WidthValue.ICON_ONLY:return"";default:console.warn("bad width value: ",width);return LabelValue.STANDARD;}}},signIn:function(){this.$.aware.signIn()},_signInKeyPress:function(e){if(13==e.which||13==e.keyCode||32==e.which||32==e.keyCode){e.preventDefault();this.signIn()}},signOut:function(){this.fire("google-signout-attempted");this.$.aware.signOut()},_signOutKeyPress:function(e){if(13==e.which||13==e.keyCode||32==e.which||32==e.keyCode){e.preventDefault();this.signOut()}}});class UserSearchBar extends LitElement{static get properties(){return{items:{type:Array}}}constructor(){super();this.items=this.items||[]}_render({items}){return html$2`
    ...
    `}handleSearchChanged(){const searchbox=this.shadowRoot.getElementById("searchbox");if(searchbox&&searchbox.value){const q=searchbox.value;this.dispatchEvent(new CustomEvent("search",{detail:{q}}))}}}customElements.define("user-search-bar",UserSearchBar);class ImageFileUploader extends LitElement{static get properties(){return{src:{type:String},emptyImageData:{type:String}}}constructor(){super();this.src=this.src||"data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=";this.emptyImageData=this.emptyImageData||"data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="}_render({src,emptyImageData}){return html$2`
      <style>
        #drop_zone {
          height: 200px;
    ...
    `}renderField(field){if(this.fieldIsCheckboxType(field)){return html$2`
      ...
      `}if(this.fieldIsTagIdType(field)){return html$2`
        <vaadin-combo-box
          ...
          class="full-width"
        />
      `}}get usersSheetName(){return"Users"}get usersSheetNumHeaders(){return 2}get activitySheetName(){return"Activity"}get activitySheetNumHeaders(){return 2}get hiddenSectionNames(){return["Initial","Hidden","Private"]}get usersNameColumn(){return this.usersColumnFromFieldTitle("Name")}get usersMakerLabsIdColumn(){return this.usersColumnFromFieldTitle("MakerLabs ID")}get usersTagIdColumn(){return this.usersColumnFromFieldTitle("Tag ID")}get activityTimestampColumn(){return"A"}get activityMachineIdColumn(){return"B"}get activityTypeColumn(){return"C"}get activityTagIdColumn(){return"E"}get activityMakerLabsIdColumn(){return"F"}usersColumnFromFieldTitle(title){if(this.fields&&this.fields.length){for(var s=0,section;s<this.fields.length;++s){section=this.fields[s];for(var f=0,field;f<section.fields.length;++f){field=section.fields[f];if(field.title==title){return field.name}}}}return null}sectionIsHidden(section){return section&&-1!=this.hiddenSectionNames.indexOf(section.title)}fieldIsCheckboxType(field){return"CHECKBOX"===field.type||"VALUE_IN_LIST"===field.type&&field.choices&&2==field.choices.length&&this.isNoLike(field.choices[0])&&this.isYesLike(field.choices[1])}fieldIsRadioGroupType(field){return"VALUE_IN_LIST"===field.type&&field.choices&&3>=field.choices.length&&!this.fieldIsCheckboxType(field)}fieldIsDropdownMenuType(field){return"VALUE_IN_LIST"===field.type&&field.choices&&3<field.choices.length}fieldIsDatePickerType(field){return"DATE_AFTER"==field.type||"DATE_BEFORE"==field.type||"DATE_BETWEEN"==field.type||"DATE_EQUAL_TO"==field.type||"DATE_IS_VALID_DATE"==field.type||"DATE_NOT_BETWEEN"==field.type||"DATE_ON_OR_AFTER"==field.type||"DATE_ON_OR_BEFORE"==field.type}fieldIsTextInputType(field){return!this.fieldIsTagIdType(field)&&(!field.type||"NUMBER_BETWEEN"==field.type||"NUMBER_EQUAL_TO"==field.type||"NUMBER_GREATER_THAN"==field.type||"NUMBER_GREATER_THAN_OR_EQUAL_TO"==field.type||"NUMBER_LESS_THAN"==field.type||"NUMBER_LESS_THAN_OR_EQUAL_TO"==field.type||"NUMBER_NOT_BETWEEN"==field.type||"NUMBER_NOT_EQUAL_TO"==field.type||"TEXT_CONTAINS"==field.type||"TEXT_DOES_NOT_CONTAIN"==field.type||"TEXT_EQUAL_TO"==field.type||"TEXT_IS_VALID_EMAIL"==field.type)}fieldIsTagIdType(field){return field.name===this.usersTagIdColumn}fieldIsImageType(field){return"TEXT_IS_VALID_URL"===field.type}handleUserNameChanged(newValue){if(newValue){if(this.usersNameColumn&&this.userName){this.queryUsers("where "+this.usersNameColumn+" = '"+this.userName+"'").then(datatable=>{var values=this.getFirstRowValuesFromDatatable(datatable);if(values&&values.length){this.showUser(values)}})}}}connectedCallback(){super.connectedCallback();this._updateGridStyles=this._updateGridStyles||(()=>{this.updateStyles()});window.addEventListener("resize",this._updateGridStyles)}disconnectedCallback(){window.removeEventListener("resize",this._updateGridStyles)}_firstRendered(){var intervalId=setInterval(()=>{if(gapi){if(gapi.client){for(var clients=this.shadowRoot.querySelectorAll("google-client-loader"),i=0;i<clients.length;i++){console.log("Force loaded gapi.client");clients[i]._loadClient()}clearInterval(intervalId)}else{console.log("Missing gapi.client");gapi.load("client",function(){})}}else{console.log("Missing gapi global")}},1e3);console.log("initialQuery");console.log(this.query);if(this.query&&"name"in this.query){this.userName=this.query.name;this.queryUsers("where "+this.usersNameColumn+" = '"+this.userName+"'").then(datatable=>{var values=this.getFirstRowValuesFromDatatable(datatable);if(values&&values.length){this.showUser(values)}})}var makerLabsIdPrev="";window.setInterval(()=>{this.queryActivity("select "+this.activityMakerLabsIdColumn+" where "+this.activityTypeColumn+" = 'Signed_In' and "+this.activityMachineIdColumn+" = '"+this.machineId+"' order by "+this.activityTimestampColumn+" desc limit 1").then(datatable=>{var values=this.getValuesFromDatatable(datatable);if(values&&values.length){for(var rowIdx=0,makerLabsId;rowIdx<values.length;rowIdx++){makerLabsId=values[rowIdx][0];if(makerLabsId!=makerLabsIdPrev){this.queryUsers("where "+this.usersMakerLabsIdColumn+" = '"+makerLabsId+"'").then(datatable=>{var values=this.getFirstRowValuesFromDatatable(datatable);if(values&&values.length){this.showUser(values)}});makerLabsIdPrev=makerLabsId}}}})},2e3);var el=this.shadowRoot.getElementById(this.usersTagIdColumn);if(el){this.queryActivity("select "+this.activityTagIdColumn+", count("+this.activityTimestampColumn+") group by "+this.activityTagIdColumn).then(datatable=>{var items=[],values=this.getValuesFromDatatable(datatable);if(values&&values.length){for(var rowIdx=0,tagId;rowIdx<values.length;rowIdx++){tagId=values[rowIdx][0];items.push({label:"Recently scanned: "+tagId,value:tagId})}el.items=items}})}}getValuesFromDatatable(datatable,limit){var values=[];if(datatable&&datatable.table&&datatable.table.rows&&0<datatable.table.rows.length&&datatable.table.cols&&0<datatable.table.cols.length){limit=limit<datatable.table.rows.length?limit:datatable.table.rows.length;for(var rowIdx=0,rowValues;rowIdx<limit;rowIdx++){rowValues=[];for(var colIdx=0,v;colIdx<datatable.table.cols.length;colIdx++){v=datatable.table.rows[rowIdx].c[colIdx]&&datatable.table.rows[rowIdx].c[colIdx].v;rowValues.push(v)}values.push(rowValues)}}return values}getFirstRowValuesFromDatatable(datatable){const limitFirstRowValues=this.getValuesFromDatatable(datatable,1);return 0<limitFirstRowValues.length?limitFirstRowValues[0]:null}querySheet(sheetName,query,numHeaders=1){var queryString=encodeURIComponent(query);const responseHandlerName=`jsonp_${Date.now()}_${_Mathceil(1e5*Math.random())}`,query_url="https://docs.google.com/spreadsheets/d/"+this.sheetId+"/gviz/tq"+"?access_token="+this.accessToken+"&sheet="+sheetName+"&headers="+numHeaders+"&tq="+queryString+"&tqx=responseHandler:"+responseHandlerName;return fetchJsonp(query_url,{jsonpCallback:"responseHandler",jsonpCallbackFunction:responseHandlerName}).then(function(response){return response.json()}).catch(function(err){console.log("Parsing Google Visualization API response failed",err)})}queryUsers(query){return this.querySheet(this.usersSheetName,query,this.usersSheetNumHeaders)}queryActivity(query){return this.querySheet(this.activitySheetName,query,this.activitySheetNumHeaders)}resetValues(){return this.showUser([])}showUser(data){for(var i=0,s=0,section;s<this.fields.length;++s){section=this.fields[s];for(var f=0;f<section.fields.length;++f){var val=i<data.length?data[i++]:null,field=section.fields[f];if(!val){val=""}if(this.fieldIsCheckboxType(field)){var el=this.shadowRoot.getElementById(field.name);el.checked=this.isYesLike(val[0])}else if(this.fieldIsRadioGroupType(field)){var el=this.shadowRoot.getElementById(field.name);el.select(val)}else if(this.fieldIsDropdownMenuType(field)){var el=this.shadowRoot.getElementById(field.name),listbox=el.querySelector("paper-listbox"),selectedIdx=field.choices.indexOf(val);listbox.selected=0<=selectedIdx?selectedIdx:0}else if(this.fieldIsDatePickerType(field)||this.fieldIsTextInputType(field)){var el=this.shadowRoot.getElementById(field.name);el.value=val}else if(this.fieldIsImageType(field)){var photoUrl=val,img=this.shadowRoot.getElementById(field.name);img.src=photoUrl}else{console.log("unknown field name "+field.name+", type "+field.type)}}}}handleSubmit(){for(var sheets=this.shadowRoot.getElementById("sheets"),validTextFieldCount=0,formValues=[],s=0,section;s<this.fields.length;++s){section=this.fields[s];for(var f=0;f<section.fields.length;++f){var formValue,field=section.fields[f],el=this.shadowRoot.getElementById(field.name);if(el){if(this.fieldIsCheckboxType(field)){formValue=el.checked?field.choices[0]:field.choices[1]}else if(this.fieldIsRadioGroupType(field)){formValue=el.selected}else if(this.fieldIsDropdownMenuType(field)){formValue=el.value}else if(this.fieldIsDatePickerType(field)||this.fieldIsTextInputType(field)){formValue=el.value;if(formValue){validTextFieldCount++}}else if(this.fieldIsImageType(field)){if(el.src!=el.emptyImageData){formValue=el.src}}else{console.log("unknown field "+field.name)}}formValues.push(formValue)}}if(sheets&&sheets.api&&formValues.length){var rowName=formValues[0];if(rowName){console.log("update rowName = "+rowName);sheets.api.spreadsheets.values.update({spreadsheetId:this.sheetId,range:this.usersSheetName+"!A"+rowName,majorDimension:"ROWS",valueInputOption:"USER_ENTERED",values:[formValues]}).then(function(response){console.log(response)})}else{console.log(formValues);if(0<validTextFieldCount){console.log("create new user");formValues[0]="=row()";sheets.api.spreadsheets.values.append({spreadsheetId:this.sheetId,range:this.usersSheetName,valueInputOption:"USER_ENTERED",insertDataOption:"INSERT_ROWS",values:[formValues]}).then(function(response){console.log(response)})}}}}isYesLike(s){return-1!=["\u2611","Y","y","T","t","Yes","yes","True","true"].indexOf(s)}isNoLike(s){return-1!=["\u2610","N","n","F","f","No","no","False","false"].indexOf(s)}arraysEqual(a,b){if(a===b)return!0;if(null==a||null==b)return!1;if(a.length!=b.length)return!1;for(var i=0;i<a.length;++i){if(a[i]!==b[i])return!1}return!0}}customElements.define("view-user-form",ViewUserForm);setPassiveTouchGestures(!0);setRootPath(MyAppGlobals.rootPath);class AppShell extends LitElement{static get properties(){return{sheetId:{type:String},machineId:{type:String},accessToken:{type:String},oauthClientId:{type:String},oauthScopes:{type:String},fieldsUrl:{type:String},_fields:{type:Array},fieldsUrl:{type:String},userName:{type:String},usersSearchColumns:{type:String},defaultPhotoUrl:{type:String},query:{type:Object}}}_render({fieldsUrl,accessToken,oauthClientId,oauthScopes,sheetId,machineId,_fields:fields,query}){return html$2`
    <style>
      app-toolbar {
...
`}static get fetchInitialQuery(){return{}}get fields(){return this._fields}set fields(fields){this._fieldsChanged(fields,this.fields);this._fields=fields}_fieldsChanged(newValue){if(newValue){const form=this.shadowRoot.getElementById("form");if(form){form.queryUsers("select "+this.usersSearchColumns).then(datatable=>{const users=[],sections=newValue.map(function(section){return section.title});if(datatable&&datatable.table&&datatable.table.rows&&datatable.table.cols){for(var rowIdx=0,currentSection;rowIdx<datatable.table.rows.length;rowIdx++){currentSection=0;const rowValues={};for(var colIdx=0,k;colIdx<datatable.table.cols.length;colIdx++){k=datatable.table.cols[colIdx].label;if(0==k.indexOf(sections[currentSection])){k=k.substr(sections[currentSection].length+1);currentSection++}k=k.replace(/\W/g,"_");const v=datatable.table.rows[rowIdx].c[colIdx]&&datatable.table.rows[rowIdx].c[colIdx].v;rowValues[k]=v}if(!("Photo"in rowValues)||!rowValues.Photo){rowValues.Photo=this.defaultPhotoUrl}if("Name"in rowValues&&rowValues.Name){users.push(rowValues)}}}const userSearchBar=this.shadowRoot.getElementById("search");if(userSearchBar){userSearchBar.items=users}})}}}connectedCallback(){super.connectedCallback();const aware=this.shadowRoot.querySelector("google-signin-aware");aware.handleAuthSignIn=this.handleAuthSignIn;aware.handleAuthSignOut=this.handleAuthSignOut;aware.handleAuthStateChange=this.handleAuthStateChange}_firstRendered(){const search=this.shadowRoot.getElementById("search"),form=this.shadowRoot.getElementById("form");search.addEventListener("search",e=>{const q=e.detail.q;form.queryUsers("where C = '"+q+"'").then(datatable=>{const values=form.getFirstRowValuesFromDatatable(datatable);if(values&&values.length){form.showUser(values)}})})}populateAccessToken(){var accessToken=null;const authInstance="object"===typeof gapi&&gapi.auth2&&gapi.auth2.getAuthInstance();if(authInstance){const currentUser=authInstance&&authInstance.currentUser&&authInstance.currentUser.get();if(currentUser){const authResponse=currentUser.getAuthResponse(!0);if(authResponse){if("access_token"in authResponse){accessToken=authResponse.access_token}}}}return accessToken}handleAuthSignIn(){console.log("handleAuthSignIn");this.accessToken=this.populateAccessToken();setInterval(()=>{this.accessToken=this.populateAccessToken()},20*(1e3*60));if(this.fieldsUrl&&0<this.fieldsUrl.length&&this.accessToken&&0<this.accessToken.length){fetch(`${this.fieldsUrl}&access_token=${this.accessToken}`).then(response=>{if(200==response.status){response.json().then(fields=>{this.fields=fields})}else{console.log(`Fields JSON request fetch failed with response code: ${response.status}`)}})}}handleAuthSignOut(){console.log("handleAuthSignOut")}handleAuthStateChange(){console.log("handleAuthStateChange")}}customElements.define("app-shell",AppShell)});